...
trait RuleCheck
{
    ...
    */// ===============================================
    public function userCardRulesCheck($input, $user)
    {
        ...
        $input['country'] = $input['country'] ?? 'NOAPP';
        ...
        foreach ($rules as $value) {
            $rule_condition = str_replace(
                ['currency', 'amount', 'card_type', 'country', 'category', 'bin_cou_code', 'card_wl'],
                ['"' . $input['currency'] . '"', '"' . $input['amount_in_usd'] . '"', $input['card_type'], '"' . $input['country'] . '"', '"' . $category . '"', '"' . $input['bin_country_code'] . '"', '"' . strval($input['is_white_label']) . '"'],
