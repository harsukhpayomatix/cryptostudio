...
{   
    public function download(Request $request)
    {
        ...
        $columns = [
            ...
            'Retrieval Count',
            'Retrieval Amount',
            'Remove Retrieval Count',
            'Remove Retrieval Fee',
            'Total Settlement',
            ...
            'Retrieval Transaction Fee Rate',
            'Retrieval Transaction Fee Amount',
        ...
        /*$data = UserGenerateReport::select(
            ...
            'usergeneratereportschild.total_retrieval',
            'usergeneratereportschild.total_retrieval_amount',
            'usergeneratereportschild.remove_past_retrieval',
            'usergeneratereportschild.past_retrieval_charge_amount',
            ...
            'usergeneratereportschild.retrieval_fee',
            'usergeneratereportschild.total_retrieval_fee',
