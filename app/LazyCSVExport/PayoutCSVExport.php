...
{   
    public function exportReportById(Request $request){
        ...
        /*$data = PayoutReport::select('payout_reports.invoice_no',
                ...
                'payout_report_children.total_retrieval',
                'payout_report_children.total_retrieval_amount',
                //'payout_report_children.remove_past_retrieval',
                //'payout_report_children.past_retrieval_charge_amount',
                ...
                'payout_report_children.retrieval_fee',
                //'payout_report_children.total_retrieval_fee',
