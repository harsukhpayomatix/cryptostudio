    ...
    public function exportReport(Request $request){
        ...
        return response()->streamDownload(function() use($columns, $input,$fileName,$type){
            ...
            $data = ReconcilationReport::select(
                    ...
                    'reconcilation_children.total_retrieval',
                    'reconcilation_children.total_retrieval_amount',
                    //'reconcilation_children.remove_past_retrieval',
                    //'reconcilation_children.past_retrieval_charge_amount',
                    ...
                    'reconcilation_children.retrieval_fee',
                    //'reconcilation_children.total_retrieval_fee',
