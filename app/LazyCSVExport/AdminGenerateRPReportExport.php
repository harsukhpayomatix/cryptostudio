...
class AdminGenerateRPReportExport
{
    ...
    public function download(Request $request)
    {
        ...
        $columns = [
            ...
            'Retrieval transaction Count',
            'Retrieval transaction Total',
        ...
        return response()->streamDownload(function() use($columns, $input) {
            ...
            $data = PayoutReportsRP::select('payout_reports_rp.invoice_no',
                            ...
                            "payout_reports_child_rp.retrieval_transaction_count",
                            "payout_reports_child_rp.retrieval_transaction_sum",
