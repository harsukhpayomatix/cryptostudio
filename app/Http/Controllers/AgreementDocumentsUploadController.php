                ...
                if ($request->hasFile('files')) {
                    ...
                    if (empty($exists->files)) {
                        ...
                        if (empty($exists->reassign_reason)) {
                            ...
                            $notification = [
                                'user_id' => '1',
                                'sendor_id' => $input['user_id'],
                                'type' => 'admin',
                                'title' => 'Agreement Resubmitted',
                                'body' => $application->business_name . ' agreement have been resubmitted.',
                        ...
                        \Session::put('success', 'Document uploaded successfully.');
                    } else {
