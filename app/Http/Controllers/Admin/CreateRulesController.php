...
{
    protected $Categories, $ExcludeRules;
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.createRules.create', compact('categories', 'type'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($rule) {
            return view('admin.createRules.edit', compact('rule', 'categories', 'conditions'));
        }
    }
