...
class MerchantPayoutReportExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    */
    public function collection()
    {
        ...
        foreach ($transactions as $key => $transaction) {
            ...
            $datatmp['retrieval_amount'] = $transaction['retrieval_amount'];
            ...
            $datatmp['retrieval_count'] = $transaction['retrieval_count'];
            ...
            $datatmp['retrieval_fee'] = $transaction['retrieval_fee'];
	...
	public function map($data): array
    {
        ...
        $data['retrieval_amount'] = (string) round($data['retrieval_amount'], 2);
        ...
        $data['retrieval_count'] = (string) round($data['retrieval_count'], 2);
        ...
        $data['retrieval_fee'] = (string) round($data['retrieval_fee'], 2);
