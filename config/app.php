...
if (file_exists($filePath)) {
    ...
    if (!empty($data)) {
        ...
        if (isset($client_ip) && in_array($client_ip, $data)) {
            $debug = true;
        }
    }
}
return [
    ...
    */
    ...
    'logo_url' => 'https://portal.finvert.io/storage/ThemeFinvert/images/finvert_logo.png',
    'logo_url2' => 'http://portal.finvert.io/storage/ThemeFinvert/images/FinvertV1.png',
    ...
    */
    ...
    'key' => 'base64:VWiLRpw5SDPlbKegdnZ6i8evsvyuiPp93gvgxlmqj38=',

    'cipher' => 'AES-256-CBC',
    'aws_path' => 'https://cryptomatixx-data.s3.eu-west-2.amazonaws.com/',
    /*
    |--------------------------------------------------------------------------
