...
$("#sa-params").on("click", function () {
    ...
    var merchant_discount_rate_master_card = document.getElementById(
    ...
    var merchant_discount_rate_amex_card = document.getElementById(
        "merchant_discount_rate_amex_card"
    ).value;
    if (merchant_discount_rate_amex_card == "") {
        $("#merchant_discount_rate_amex_card_error").html(
            "This field is required."
        );
        isError = true;
    } else {
    ...
    var merchant_discount_rate_discover_card = document.getElementById(
        "merchant_discount_rate_discover_card"
    ).value;
    if (merchant_discount_rate_discover_card == "") {
        $("#merchant_discount_rate_discover_card_error").html(
            "This field is required."
        );
        isError = true;
    } else {
    ...
    var merchant_discount_rate_upi = document.getElementById(
        "merchant_discount_rate_upi"
    ).value;
    if (merchant_discount_rate_upi == "") {
        $("#merchant_discount_rate_upi_error").html("This field is required.");
        isError = true;
    } else {
        $("#merchant_discount_rate_upi_error").html("");
        isError = false;
    }

    var merchant_discount_rate_crypto = document.getElementById(
        "merchant_discount_rate_crypto"
    ).value;
    if (merchant_discount_rate_crypto == "") {
        $("#merchant_discount_rate_crypto_error").html(
            "This field is required."
        );
        isError = true;
    } else {
    ...
    var setup_fee_master_card = document.getElementById(
    ...
    var setup_fee_amex_card = document.getElementById(
        "setup_fee_amex_card"
    ).value;
    if (setup_fee_amex_card == "") {
        $("#setup_fee_amex_card_error").html("This field is required.");
        isError = true;
    } else {
        $("#setup_fee_amex_card_error").html("");
        isError = false;
    }

    var setup_fee_discover_card = document.getElementById(
        "setup_fee_discover_card"
    ).value;
    if (setup_fee_discover_card == "") {
        $("#setup_fee_discover_card_error").html("This field is required.");
        isError = true;
    } else {
        $("#setup_fee_discover_card_error").html("");
        isError = false;
    }
    ...
    if (agent == "") {
        ...
        if (agent != "0" && rpMasterCommission == "") {
            $("#agent_commission_master_error").html("This field is required.");
            isError = true;
        } else {
            $("#agent_commission_master_error").html("");
            isError = false;
        }
        $("#agent_error").html("");
        agent = agent;
            ...
            function () {
                $.ajax({
                    ...
                    data: {
                        ...
                        merchant_discount_rate_master_card:
                            merchant_discount_rate_master_card,
                        setup_fee_master_card: setup_fee_master_card,
                        merchant_discount_rate_amex_card:
                            merchant_discount_rate_amex_card,
                        merchant_discount_rate_discover_card:
                            merchant_discount_rate_discover_card,
                        merchant_discount_rate_upi: merchant_discount_rate_upi,
                        merchant_discount_rate_crypto:
                            merchant_discount_rate_crypto,
                        setup_fee_amex_card: setup_fee_amex_card,
                        setup_fee_discover_card: setup_fee_discover_card,
                        minimum_settlement_amount: minimum_settlement_amount,
                        payment_frequency: payment_frequency,
                        agent_commission:
                            rpVisaCommission != "" ? rpVisaCommission : 0.0,
                        agent_commission_master:
                            rpMasterCommission != "" ? rpMasterCommission : 0.0,
                    },
                    beforeSend: function () {
                        // setting a timeout
