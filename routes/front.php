...
Route::group(['middleware' => 'notification_read_user'], function () {
    ...
    Route::group(['middleware' => 'checkUserProfile'], function () {
        ...
        Route::get('payout_report/pdf/{id}', 'PayoutScheduleController@generatePDF')->name('payout_report.pdf');
    ...
    Route::group(['middleware' => 'authcheck'], function () {
        ...
        Route::post('transactions/export', '\App\LazyCSVExport\TransactionmanagementCSVExport@download')->name('transactions.exportAllTransactions');
        ...
        Route::post('merchant-test-export', '\App\LazyCSVExport\MerchantTestTransactionmanagementCSVExport@download')->name('testTransactions.export');
        ...
        Route::get('whitelist-ip-csv-export', '\App\LazyCSVExport\WhitelistIP@download')->name('whitelist-ip-csv-export');
