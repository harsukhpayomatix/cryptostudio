...
Route::group(['middleware' => 'notification_read_agent'], function () {
	...
	Route::get('my-application/create', 'Agent\ApplicationController@create')->name('rp.my-application.create');
	...
	Route::get('merchant-transactions', 'Agent\MerchantTransactionController@index')->name('rp-merchant-transactions');
	...
	Route::get('rp-merchant-transaction-report', 'Agent\ReportController@merchantTransactionsReport')->name('rp.merchant-transaction-report');
	...
	Route::get('rp-commision-report', 'Agent\ReportController@commisionReport')->name('rp.commision-report');
