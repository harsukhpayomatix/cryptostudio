...
Route::get('rp/register', 'Auth\AgentUserAuthController@register')->name('agent.register');
Route::post('rp/store', 'Auth\AgentUserAuthController@store')->name('agent.store');
Route::get('rp-activate/{token}', 'Auth\AgentUserAuthController@verifyUserEmail')->name('agent-activate');
...
Route::get('/agreement-documents-upload', 'AgreementDocumentsUploadController@index')->name('agreement-documents-upload');
Route::post('/agreement-documents-upload', 'AgreementDocumentsUploadController@store')->name('agreement-documents-upload');
Route::get('/rp-agreement-documents-upload', 'AgreementDocumentsUploadController@uploadRP')->name('rp-agreement-documents-upload');
Route::post('/rp-agreement-documents-upload', 'AgreementDocumentsUploadController@storeRP')->name('rp-agreement-documents-upload');
...
/********************* Gateway route Start *************************************/
// test gateway
Route::get('payment/test-transaction/{session_id}', 'Repo\PaymentGateway\TestGateway@stripeForm')->name('test-stripe');
Route::post('payment/test-transaction/{session_id}', 'Repo\PaymentGateway\TestGateway@test3DSFormSubmit')->name('test-stripe-submit');
...
// iframe v1
Route::get('iframe-checkout/{token}', 'iFrameCheckoutController@index')->name('iframe.checkout');
Route::post('checkout-form/{token}', 'iFrameCheckoutController@store')->name('checkout-form');
Route::get('hosted/response/{token}', 'iFrameCheckoutController@hostedCheckoutResponse')->name('hosted-checkout-response');
...
// API document
Route::get('api-document', 'APIDocumentController@index')->name('api-document');
Route::get('user-api/directpayapi', 'UserAPIController@directpayapi')->name('directpayapi');
Route::get('user-api/hostedpayapiv2', 'UserAPIController@directpayapiv2')->name('directpayapiv2');
...
Route::get('user-api/gettransactiondetailsapi', 'UserAPIController@gettransactiondetailsapi')->name('gettransactiondetailsapi');
...
Route::get('api/v2/checkout/{id}', 'API\ApiController@checkout')->name('api.v2.checkout');
...
Route::post('api/v2/submit/card-details/{id}', 'API\ApiController@extraDetailsFormSubmit')->name('api.v2.extraDetailsFormSubmit');
...
Route::get('api/v2/response/success/{id}', 'API\ApiController@success')->name('api.v2.success');
...
// budpay
Route::get('budpay/callback', 'Repo\PaymentGateway\BudPay@callback')->name("budpay.callback");
...
// MilkyPay
Route::get("milkypay/return/{id}", "Repo\PaymentGateway\MilkyPay@return")->name("milkypay.return");
...
Route::get("/milkypay/browser/{id}", "Repo\PaymentGateway\MilkyPay@getBrowserInfo")->name('milkypay.getBrowser.info');
...
// * Payaza routes
Route::get('/payaza-3ds/{id}', "Repo\PaymentGateway\Payaza@payaza3ds")->name("payaza.3ds");
Route::any('/payaza-return/{id}', "Repo\PaymentGateway\Payaza@payazaReturn")->name("payaza.return");
