            ...
            <div class="col-md-12">
                <div class="row" style="background-color: #262626; padding: 15px 0px;">
                    @if (auth()->guard('admin'))
                        ...
                        @if ($data->is_retrieval == '1' && $data->is_retrieval_remove == '0')
                            <div class="col-md-2">
                                <td>
                                    <div class="form-check">
                                        <input type="checkbox" name="retrieval"
                                            class="clRetrievalChecked form-check-input"
                                            id="retrieval{{ $data->id }}" data-id="{{ $data->id }}" checked
                                            data-bs-toggle="modal" href="#transactionRetrieval">
                                        <label for="retrieval{{ $data->id }}"
                                            class="form-check-label">Retrieval</label>
                                    </div>
                                </td>
                            </div>
                        @elseif(
                        ...
                        @else
                            <div class="col-md-2">
                                <td>
                                    <div class="form-check">
                                        <input type="checkbox" name="retrieval" class="clRetrieval form-check-input"
                                            id="retrieval{{ $data->id }}" data-id="{{ $data->id }}"
                                            data-bs-toggle="modal" href="#transactionRetrieval"
                                            {{ $data->is_retrieval_remove == '1' ? 'disabled' : '' }}>
                                        <label for="retrieval{{ $data->id }}"
                                            class="form-check-label">Retrieval</label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                @if ($data->is_retrieval == '1')
                                    <td>
                                        ...
                                        <br>
                                        <label class="badge badge-sm badge-success">YES</label>
                                    </td>
                                    <td>
                                        <strong>Retrieval Date</strong>
                                        <p class="mb-0">
                                            {{ date('d-m-Y / H:i:s', strtotime($data->retrieval_date)) }}
                                        </p>
                                    </td>
                                @endif
                            </tr>
