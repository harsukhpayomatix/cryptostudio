...
<head>
    ...
    <title>{{ config('app.name') }} | BTPay Payment</title>
    <!-- Favicon icon -->
...
<body>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-4 col-md-offset-4 text-center page-background">
                    <img style="max-width: 60%;margin-top: 10px;" src="{{ storage_asset('theme/images/Logo.png') }}" />
                    <br /><br />
        ...
        <div class="row" style="display: none;">
            <div class="col-md-12">
                <div class="col-md-4 col-md-offset-4 text-center page-background">
                    <img style="max-width: 60%;margin-top: 10px;" src="{{ storage_asset('theme/images/Logo.png') }}" />
                    <br /><br />
                    <form action="{{route('btpay-confirmation-submit')}}" method="post" id="paymentForm"
                        name="paymentForm">
                        @csrf
    ...
    <script type='text/javascript' charset='utf-8'>
        $(document).ready(function() { 
                ...
                var src = 'https://co.bestoppay.com/pub/som.js';;
