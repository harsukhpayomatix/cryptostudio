...
<head>
    ...
    <title>{{ config('app.name') }} | Test Bank Transaction Page</title>
                ...
                <div class="col-md-4 col-xl-4 col-xxl-4">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <img src="{{ storage_asset('ThemeCryptoStudio/images/login/finvert.png') }}" alt="" width="250px">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mt-2">
                                <div class="card-body gateway-card">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <h3 class="text-primary">Amount : {{ $request_data['amount']. ' ' .$request_data['currency'] }}</h3>
                                            <p>Select any response.</p>
                                        </div>

                                        <div class="col-md-12">
                                            <form action="{{ route('test-bank-transaction-submit',$session_id) }}" method="post">
                                                @csrf
