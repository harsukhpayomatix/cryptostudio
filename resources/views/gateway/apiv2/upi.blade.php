...
<head>
    ...
    <title>{{ config('app.name') }} | {{ __('messages.pageTitleUPI') }}</title>
...
<body>
                                ...
                                <div class="card-body gateway-card">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <p class="text-danger">{{ __('messages.payWithUPIText') }}</p>
                                        ...
                                        <div class="col-md-12">
                                            <form action="{{ route('api.v2.upiSubmit', $order_id) }}"
                                                id="extra-details-form" method="post" class="validity">
                                                @csrf
                                                <div class="auth-form">
                                                    <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                @if (in_array('upi', $data))
                                                                    <div class="col-md-12 form-group mb-1">
                                                                        <label>{{ __('messages.upiId') }}</label>
                                                                        <input class="form-control required-field"
                                                                            name="upi" type="text" id="upi"
                                                                            placeholder="Ex. 9898098980@upi"
                                                                            minlength="2" maxlength="50"
                                                                            value="{{ $input['upi'] ?? null }}"
                                                                            required
                                                                            data-missing="UPI field is required">
                                                                        @if ($errors->has('upi'))
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#submit-button', function(e) {
            ...
            $.ajax({
                url: '{{ route('api.v2.upiSubmit', $order_id) }}',
                type: 'post',
                data: data,
                beforeSend: function() {
