                                        ...
                                        <div class="row">
                                            ...
                                            @if (in_array('last_name', $required_fields))
                                                <div class="col-md-6 form-group mb-1">
                                                    ...
                                                    <div><input type="text" name="last_name" class="form-control"
                                            ...
                                            @endif
                                            @if (in_array('phone_no', $required_fields))
                                                <div class="col-md-12 form-group mb-1">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label
                                                        ...
                                                        <div class="col-md-9">
                                                            <label
                                                                ...
                                                                <span class="text-danger">*</span></label>
                                                            <div><input class="form-control" name="phone_no"
                                                                    type="text"
                                                                    placeholder="{{ __('messages.enterHere') }}"
                                                                    id="phone_no"
                                                                    value="{{ isset($_GET['phone_no']) ? $_GET['phone_no'] : '' }}"
                                                                    {{ isset($_GET['phone_no']) ? 'readonly' : '' }}
                                                                    required data-missing="This field is required">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <sub class="text-danger">{{ __('messages.phoneText') }}.</sub>
                                            ...
                                            @endif
                                            @if (in_array('currency', $required_fields))
                                                <div class="col-md-12 form-group mb-1">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <label class="mb-25">{{ __('messages.amount') }} <span
                                                                    class="text-danger">*</span></label>
                                                            <div><input class="form-control" name="amount"
                                                                    type="text"
                                                                    placeholder="{{ __('messages.enterHere') }}"
                                                                    id="amount"
                                            ...
                                            @if (in_array('address', $required_fields))
                                                <div class="col-md-12 form-group mb-1">
                                                    <label class="mb-25">{{ __('messages.address') }} <span
                                                            class="text-danger">*</span></label>
                                                    <div>
                                                        <textarea class="form-control" name="address" id="address" placeholder="{{ __('messages.enterHere') }}"
                                                            {{ isset($_GET['address']) ? 'readonly' : '' }} required data-missing="This field is required">{{ isset($_GET['address']) ? $_GET['address'] : '' }}</textarea>
                                                    </div>
                                            ...
                                            @if (in_array('country', $required_fields))
                                                <div class="col-md-6 form-group mb-1">
                                                    ...
                                                    @if (isset($_GET['country']))
                                                        <text" name="country" class="form-control"
                                            ...
                                            @if (in_array('zip', $required_fields))
                                                <div class="col-md-6 form-group mb-1">
                                                    <label class="mb-25">{{ __('messages.zipCode') }} <span
                                                            class="text-danger">*</span></label>
                                                    <div><input class="form-control" name="zip" type="text"
                                                            id="zip"
                                                            placeholder="{{ __('messages.enterHere') }}"
                                            ...
                                            @if (in_array('city', $required_fields))
                                                <div class="col-md-6 form-group mb-1">
                                                    <label class="mb-25">{{ __('messages.city') }} <span
                                                            class="text-danger">*</span></label>
                                                    <div><input class="form-control" name="city" type="text"
                                                            id="city"
                                                            placeholder="{{ __('messages.enterHere') }}"
