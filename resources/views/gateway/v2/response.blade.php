...
<body class="h-100">
    <div class="container" style="margin-top: 10em;">
      ...
      <div class="col-sm-12 col-md-12 col-lg-12 text-center mb-5">
        <img src="{{ storage_asset('ThemeCryptoStudio/images/login/logo.png') }}" alt="" width="300px">
      </div>
    </div> --}}
        @if (isset($response['responseCode']) && $response['responseCode'] == '0')
            <div class="row">
                <div class="modalbox error col-sm-8 col-md-6 col-lg-5 center animate">
                    ...
                    <a href="{{ route('iframe2.checkout', $token) }}" class="btn btn-primary btn-block btn-lg">New
                        Transaction</a>
                </div>
            </div>
        ...
        @elseif(isset($response['responseCode']) && $response['responseCode'] == '5')
            <div class="row">
                <div class="modalbox error col-sm-8 col-md-6 col-lg-5 center animate">
                    <div class="icon">
