            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-xxl-6">
                            <div id="accordion-eleven4" class="accordion accordion-rounded-stylish accordion-bordered">
                                <div class="accordion__item">
                                    <div class="accordion__header collapsed accordion__header--info"
                                        data-bs-toggle="collapse" data-bs-target="#rounded-stylish_collapseFour">
                                        <span class="accordion__header--icon"></span>
                                        <span class="accordion__header--text">Retrieval</span>
                                        <span class="accordion__header--indicator"></span>
                                    </div>
                                    <div id="rounded-stylish_collapseFour" class="collapse accordion__body"
                                        data-parent="#accordion-eleven4">
                                        <div class="accordion__body--text p-0">
                                            <div class="table-responsive tableFixHead">
                                                <table class="table table-bordered">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        @if (count($transactions_summary) > 0)
                                                            @foreach ($transactions_summary['retrieval'] as $transaction)
                                                                <tr>
                                                                    <td>{{ $transaction->currency }}</td>
                                                                    <td class="text-right">
                                                                        {{ $transaction->retrieval_count }}</td>
                                                                    <td class="text-right">
                                                                        {{ $transaction->retrieval_amount }}</td>
                                                                    <td class="text-right">
