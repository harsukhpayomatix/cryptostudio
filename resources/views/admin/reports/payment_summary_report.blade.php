...
@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Payment status summary Report
@endsection
@section('content')
    <?php
        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card mt-1">
                <div class="card-header">
                    ...
                    <div>
                        <div class="btn-group">
                            ...
                            <a href="{{ route('payment-status-summary-report') }}" class="btn btn-danger btn-sm"
                                style="border-radius: 0px 5px 5px 0px !important;">Reset</a>
                        </div>
                        @if (auth()->guard('admin')->user()->can(['export-payment-status-summary-report']) && isset($_GET['status']))
                            <a class="btn btn-info btn-sm"
                                href="{{ route('payment-status-summary-report-excle', ['status' => $_GET['status']]) }}"
                                data-filename="Payment_Status_Report_Excel_" id="ExcelLink">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive tableFixHead custom-table">
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>&nbsp;</th>
                                        <th colspan="3"
                                            class="text-center {{ $payment_status_class[$_GET['status']] }}">
                                        ...
                                        @foreach ($user_transaction as $ks => $transaction)
                                            <tr>
                                                ...
                                                @elseif($_GET['status'] == 6)
                                                    <td class="text-right">{{ $transaction['retrieval_count'] }}</td>
                                                    <td class="text-right">
