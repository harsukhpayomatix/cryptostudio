...
@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / MID Approval Rate
@endsection
@section('content')
            ...
            <div class="card mt-1">
                <div class="card-header">
                    <div class="iq-header-title">
                        <h4 class="card-title">MID Approval Rate <span class="text-red"> (
                    ...
                    <div>
                        <div class="btn-group">
                            ...
                            <a href="{{ route('merchant-transactions-approval-report') }}" class="btn btn-danger btn-sm"
                        ...
                        <table class="table table-striped table-borderless">
                            <thead>
                                <tr>
                                    ...
                                    <th>Merchant Name</th>
                                    <th>Card Type</th>
                                    <th class="text-green">Successful Count (%)</th>
                                    <th class="text-red">Declined Count (%)</th>
                                </tr>
                            </thead>
                            <tbody>
