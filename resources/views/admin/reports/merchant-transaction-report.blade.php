    ...
    <div class="row">
        <div class="col-lg-12 mb-3 text-right">
            ...
            @if (!empty($subQueryString))
                <a href="{{ route('merchant.reports.export', [$subQueryString]) }}" class="btn btn-info btn-sm"
                    id="ExcelLink">
        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card  mt-1">
                <div class="card-header">
                    ...
                    <div>
                        <select class="form-control-sm form-control" name="user_id" id="user_id" style="">
                        ...
                        <!-- <div class="btn-group">
                                                                                                    <button type="button" class="btn btn-info bell-link btn-sm" data-bs-toggle="modal" data-bs-target="#searchModal"> <i class="fa fa-search-plus"></i>
                                                                                                        Advanced Search</button>
                                                                                                    <a href="{{ route('admin.transactions') }}" class="btn btn-primary btn-sm">Reset</a>
                            ...
                            <tbody>
                                @foreach ($data as $transaction)
                                    <tr id="tr_{{ $transaction['id'] }}">
                                        ...
                                        <td>{{ $transaction['retrieval_amount'] }}</td>
                                        ...
                                        <td>{{ $transaction['retrieval_fee'] }}</td>
...
@section('customScript')
    ...
    <script>
        $(document).on("change", "#user_id", function() {
            ...
            if (user_id != 0) {
                location.href = "{{ route('merchant.reports') }}?user_id=" + user_id;
            } else {
                location.href = "{{ route('merchant.reports') }}";
            }
        });
    </script>
@endsection
