...
@section('title')
    Application-Sent Agreements
@endsection

@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Application-Sent Agreements
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            <h4 class="card-title">Application-Sent Agreements</h4>

        </div>
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.exportAllAgreementSend', request()->all()) }}"
                    data-filename="Agreement_Sent_Application" class="btn btn-primary btn-sm" id="ExcelLink"><i
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.applications.agreement_send') }}" class="btn btn-danger btn-sm"
