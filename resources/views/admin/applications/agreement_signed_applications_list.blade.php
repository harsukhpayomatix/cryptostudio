...
@section('title')
    Application-Signed Agreements
@endsection

@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Application-Signed Agreements
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            <h4 class="me-50">Application-Signed Agreements</h4>
        </div>
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.exportAllAgreementSigned', request()->all()) }}"
                    data-filename="Signed_Agreement_Application" class="btn btn-primary btn-sm" id="ExcelLink"><i
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.applications.agreement_signed') }}" class="btn btn-danger btn-sm"
