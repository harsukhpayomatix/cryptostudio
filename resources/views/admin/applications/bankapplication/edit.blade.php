                        ...
                        <form action="{{ route('application-bank.update') }}" method="post" enctype="multipart/form-data"
                                        ...
                                        @if ($application->is_license_applied)
                                            <div class="col-md-12 mt-2">
                                                <a href="{{ getS3Url($application->license_image) }}" target="_blank"
                                                    class="mr-4 btn btn-primary btn-sm">Show</a>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control"
                                            id="validationCustomFile1" name="passport[]">
                                            ...
                                            @foreach (json_decode($application->passport) as $key => $value)
                                                <div class="col-md-4 mt-2">
                                                    ...
                                                    <a href="{{ getS3Url($value) }}" target="_blank"
                                                        class="mr-4 btn btn-primary btn-sm pull-right">Show</a>
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control"
                                            id="validationCustomFile2" name="latest_bank_account_statement[]">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control"
                                            id="validationCustomFile3" name="utility_bill[]">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control"
                                            id="validationCustomFile4" name="company_incorporation_certificate">
                                    ...
                                    @if ($application->company_incorporation_certificate != null)
                                        <a href="{{ getS3Url($application->company_incorporation_certificate) }}"
                                            target="_blank" class="btn btn-primary btn-sm mt-1">Show</a>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control"
                                            id="validationCustomFile5" name="article_of_accociasion">


                                    </div>
                                    <div class="dynamicArticleOfAccociasionFields"></div>
                                    ...
                                    @if ($application->article_of_accociasion != null)
                                        <a href="{{ getS3Url($application->article_of_accociasion) }}" target="_blank"
                                            class="btn btn-primary btn-sm mt-1">Show</a>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control"
                                            id="validationCustomFile5" name="tax_certificate">
