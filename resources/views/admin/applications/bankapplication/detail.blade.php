                ...
                <div class="card-body">
                    <div class="row">
                        @if (isset($application->passport) && $application->passport != null)
                            <div class="col-md-2 mt-2"><strong>Passport</strong></div>
                            <div class="col-md-6 mb-2">
                                @foreach (json_decode($application->passport) as $key => $passport)
                                    <div class="row">
                                        <div class="col-md-2 mt-2">File - {{ $key + 1 }}</div>
                                        <div class="col-md-8 mt-2">
                                            <a href="{{ getS3Url($passport) }}" target="_blank"
                                                class="btn btn-primary btn-sm">Show</a>
                                            <a href="{{ route('downloadBankApplicationDocumentsUpload', ['file' => $passport]) }}"
                    ...
                    <div class="row">
                        @if (isset($application->latest_bank_account_statement) && $application->latest_bank_account_statement != null)
                            <div class="col-md-2 mt-2"><strong>Latest Bank Account Statement</strong></div>
                            <div class="col-md-6 mb-2">
                                @foreach (json_decode($application->latest_bank_account_statement) as $key => $statement)
                                    <div class="row">
                                        <div class="col-md-2 mt-2">File - {{ $key + 1 }}</div>
                                        <div class="col-md-8 mt-2">
                                            <a href="{{ getS3Url($statement) }}" target="_blank"
                                                class="btn btn-primary btn-sm">Show</a>
                                            <a href="{{ route('downloadBankApplicationDocumentsUpload', ['file' => $statement]) }}"
                                                class="btn btn-danger btn-sm">Download</a>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="row">
                        @if (isset($application->utility_bill) && $application->utility_bill != null)
                            <div class="col-md-2 mt-2"><strong>Utility Bill</strong></div>
                            <div class="col-md-6 mb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 mt-2">
                                            <a href="{{ getS3Url($utilityBill) }}" target="_blank"
                                                class="btn btn-primary btn-sm">Show</a>
                                            <a href="{{ route('downloadBankApplicationDocumentsUpload', ['file' => $utilityBill]) }}"
                                                class="btn btn-danger btn-sm">Download</a>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="row">
                        @if (isset($application->company_incorporation_certificate) && $application->company_incorporation_certificate != null)
                            <div class="col-md-2 mt-2"><strong>Articles Of Incorporation</strong></div>
                            <div class="col-md-6 mb-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mt-2">
                                        ...
                                        <a href="{{ route('downloadBankApplicationDocumentsUpload', ['file' => $application->company_incorporation_certificate]) }}"
                                            class="btn btn-danger btn-sm">Download</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        @if (isset($application->article_of_accociasion) && $application->article_of_accociasion != null)
                            <div class="col-md-2 mt-2"><strong>Article Of Accociasion</strong></div>
                            <div class="col-md-6 mb-2">
                                <div class="row">
                                    <div class="col-md-2 mt-2"></div>
                                    <div class="col-md-8 mt-2">
                                        <a href="{{ getS3Url($application->article_of_accociasion) }}" target="_blank"
                                            class="btn btn-primary btn-sm">Show</a>
                                        <a href="{{ route('downloadBankApplicationDocumentsUpload', ['file' => $application->article_of_accociasion]) }}"
                                            class="btn btn-danger btn-sm">Download</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        @if (isset($application->tax_certificate) && $application->tax_certificate != null)
                            <div class="col-md-2 mt-2"><strong>Tax Certificate</strong></div>
                            <div class="col-md-6 mb-2">
                                <div class="row">
                                    <div class="col-md-2 mt-2"></div>
                                    <div class="col-md-8 mt-2">
                                        <a href="{{ getS3Url($application->tax_certificate) }}" target="_blank"
                                            class="btn btn-primary btn-sm">Show</a>
                                        <a href="{{ route('downloadBankApplicationDocumentsUpload', ['file' => $application->tax_certificate]) }}"
                                            class="btn btn-danger btn-sm">Download</a>
                                    </div>
                                </div>
                            </div>
