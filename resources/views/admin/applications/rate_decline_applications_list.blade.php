...
@section('title')
    Rate Decline Applications
@endsection

@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Rate Decline Applications
@endsection
...
@section('content')
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select name="technology_partner_id" id="technology_partner" data-size="7"
                                        data-live-search="true" class="select2 btn-primary fill_selectbtn_in own_selectbox"
                                        data-width="100%">
                                        <option selected disabled>Select here</option>
    ...
    <div class="row">
        <div class="col-lg-6">
            <h4 class="me-50">Rate Decline Applications</h4>
        </div>
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.rate_decline.export', request()->all()) }}"
                    data-filename="Rate_Decline_Merchants_" class="btn btn-primary btn-sm" id="ExcelLink"><i
            ...
            <div class="card mt-1">
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group mx-1">
                            ...
                            <a href="{{ route('admin.applications.rate_decline') }}" class="btn btn-danger btn-sm"
                ...
                <div class="card-body p-0">
                    <div class="table-responsive custom-table">
                        <table id="approved_applications_list" class="table table-borderless table-striped">
                            <thead>
                                <tr>
                                    <th>
        ...
        <div class="modal-dialog modal-lg modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="SendMailForm" method="POST" enctype="multipart/form-data">
                    <div class="modal-body" id="SendMailBody" class="form-dark">
                        @csrf
