...
@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / In Progress Applications
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            <h4 class="me-50">In Progress Applications</h4>
        </div>
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.exportAllCompleted', request()->all()) }}" {{--            data-link="{{ route('admin.applications.exportAllCompleted', ['type' => 'xlsx']+request()->all()) }}" --}}
                    data-filename="Complete_Application" class="btn btn-primary btn-sm btn-shadow" id="ExcelLink"><i
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.applications.is_completed') }}" class="btn btn-danger btn-sm"
