...
@section('title')
    Rate Accepted Applications
@endsection

@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Rate Accepted Applications
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            <h4 class="me-50">Rate Accepted Applications</h4>
        </div>
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.rate_accepted.export', request()->all()) }}"
                    data-filename="Rate_Accepted_Merchants_" class="btn btn-primary btn-sm" id="ExcelLink"><i
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group mx-1">
                            ...
                            <a href="{{ route('admin.applications.rate_accepted') }}" class="btn btn-danger btn-sm"
