...
@section('title')
    Not Interesdted Applications
@endsection

@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Not Interested Applications
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            <h4 class="card-title">Not Interested Applications</h4>
        </div>
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.exportAllNotInterested', request()->all()) }}"
                    data-filename="Not_Interested_Application" class="btn btn-primary btn-sm" id="ExcelLink"><i
            ...
            <div class="card  mt-1">
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.applications.not_interested') }}" class="btn btn-danger btn-sm"
                ...
                <div class="card-body p-0">
                    <div class="table-responsive custom-table">
                        <table id="not_interested_applications_list" class="table table-borderless table-striped">
                            <thead>
                                <tr>
                                    <th>
                                            ...
                                            <td>
                                                <div class="dropdown ml-auto">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @endif
                                                        @if (auth()->guard('admin')->user()->can(['update-application']))
                                                            <a href="{{ route('change.notInterest.app', $value->id) }}"
                                                                class="dropdown-item"><i
                                                                    class="fa fa-window-restore text-secondary me-2"></i>
                                                                Restore
                                                            </a>
                                                            </li>
                                                        @endif
