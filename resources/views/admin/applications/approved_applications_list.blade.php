...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            <h4 class="card-title">Pre Approval Applications</h4>
        </div>
        <div class="col-lg-6 text-right">

            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.exportAllApproved', request()->all()) }}" {{--           data-link="{{ route('admin.applications.exportAllApproved', request()->all()) }}" --}}
                    data-filename="Approved_Application" class="btn btn-primary btn-sm" id="ExcelLink"><i
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.applications.is_approved') }}" class="btn btn-danger btn-sm"
