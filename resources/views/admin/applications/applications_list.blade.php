...
@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Applications
@endsection
...
@section('content')
                    ...
                    <div class="modal-body">
                        <div class="basic-form">
                            <div class="row ">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select name="status" data-size="7" data-live-search="true"
                                        ...
                                        <option value="4"
                                            ...
                                            Pre Approval</option>
                                        <option value="9"
                                            {{ isset($_GET['status']) && $_GET['status'] == '9' ? 'selected' : '' }}>
                                            Rate Decline</option>
                                        <option value="10"
                                            {{ isset($_GET['status']) && $_GET['status'] == '10' ? 'selected' : '' }}>
                                            Rate Accepted</option>
                                        <option value="5"
                                            {{ isset($_GET['status']) && $_GET['status'] == '5' ? 'selected' : '' }}>
                                            Agreement Sent</option>
                                        <option value="11"
                                            {{ isset($_GET['status']) && $_GET['status'] == '5' ? 'selected' : '' }}>
                                            Signed Agreement</option>
                                        <option value="6"
                                            {{ isset($_GET['status']) && $_GET['status'] == '6' ? 'selected' : '' }}>
                                            Agreement Received</option>
                                        <option value="7"
                                            {{ isset($_GET['status']) && $_GET['status'] == '7' ? 'selected' : '' }}>Not
                                            Interested</option>
                                        <option value="3"
                                            {{ isset($_GET['status']) && $_GET['status'] == '3' ? 'selected' : '' }}>
                                            Rejected</option>
                                        <option value="8"
                                            {{ isset($_GET['status']) && $_GET['status'] == '8' ? 'selected' : '' }}>
                                            Terminated</option>
                                    </select>
                                ...
                                <div class="form-group col-lg-6 select2-container-suctom">
    ...
    <div class="row">
        <div class="col-lg-6">
            <h4 class="me-50">Applications</h4>
        </div>
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.exportAllApplications', request()->all()) }}"
                    data-filename="All_Application_" class="btn btn-primary btn-sm" id="ExcelLink"><i
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.applications.list') }}" class="btn btn-danger btn-sm"
                                ...
                                @if (!empty($applications) && $applications->count())
                                    @foreach ($applications as $key => $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ strlen($value->business_name) > 50 ? substr($value->business_name, 0, 30) . '...' : $value->business_name }}
