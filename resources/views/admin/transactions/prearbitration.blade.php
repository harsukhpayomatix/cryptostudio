...
@section('title')
    Pre Arbitration Transactions
@endsection

@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Pre Arbitration Transactions
@endsection
@section('content')
    @include('requestDate')
                    ...
                    <div class="modal-body">
                        <div class="basic-form">
                            <div class="row ">
                                ...
                                <div class="form-group col-lg-6">
                                    <label>Pre Arbitration Start Date</label>
                                    <div class="date-input">
                                        <input class="form-control" type="text" name="prearbitration_start_date"
                                            placeholder="Enter here..." id="prearbitration_start_date"
                                            value="{{ isset($_GET['prearbitration_start_date']) && $_GET['prearbitration_start_date'] != '' ? $_GET['prearbitration_start_date'] : '' }}"
                                            autocomplete="off">

                                    </div>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label>Pre Arbitration End Date</label>
                                    <div class="date-input">
                                        <input class="form-control" type="text" name="prearbitration_end_date"
                                            placeholder="Enter here..." id="prearbitration_end_date"
                                            value="{{ isset($_GET['prearbitration_end_date']) && $_GET['prearbitration_end_date'] != '' ? $_GET['prearbitration_end_date'] : '' }}"
                                            autocomplete="off">
        ...
        <div class="col-lg-12 mb-2 text-right">
            ...
            @if (auth()->guard('admin')->user()->can(['export-all-transaction']))
                @if (!empty($subQueryString))
                    <a href="{{ route('all-admin-prearbitration-transactions-csv-export', [$subQueryString]) }}"
                        class="btn btn-primary"><i class="fa fa-download me-2"></i> Export Excel </a>
                @else
                    <a href="{{ route('all-admin-prearbitration-transactions-csv-export') }}" class="btn btn-primary"
                        id="ExcelLink">
            ...
            @if (auth()->guard('admin')->user()->can(['send-pre-arbitration-notice']))
                <a href="javascript:;" class="btn btn-primary" id="preArbitrationNotice">Send Pre
            ...
            <div class="card">
                <div class="card-header">
                    <div class="header-title">
                        <h4 class="card-title">Pre Arbitration Transactions</h4>
                    </div>
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.pre.arbitration') }}" class="btn btn-danger btn-sm"
                        ...
                        <table class="table table-borderless table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Order No</th>
                                    <th style="min-width: 230px;">Pre Arbitration Date & Time</th>
                                ...
                                @if (count($data) > 0)
                                    @foreach ($data as $transaction)
                                        @if ($transaction->is_pre_arbitration == '1')
                                            <tr id="tr_{{ $transaction->id }}" class="">
                                            @else
                                        ...
                                        <td>
                                            @if (auth()->guard('admin')->user()->can(['view-pre-arbitration']))
                                        ...
                                        <td>
                                            {{ $transaction->pre_arbitration_date }}
                                        </td>
                                        <td>
                                            <span>
                                                <div class="d-flex align-items-center">
                                                    <span class="w-space-no">
                                                        ...
                                                        <label
                                                            class="light badge-sm badge badge-success">{{ $transaction->request_origin }}</label>
                                                        <label
                                                            class="light badge-sm badge badge-primary">{{ $transaction->request_from_ip }}</label>
                                                    </span>
                                                </div>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    @endif
                                                    @if (auth()->guard('admin')->user()->can(['update-pre-arbitration']))
                                                        @if (!empty($transaction->transactions_document_upload_files))
                                                            <a data-bs-toggle="modal"
                                                                data-bs-target="#transactionShowModal"
