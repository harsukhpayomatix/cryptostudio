...
@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Declined Transactions
@endsection
@section('content')
    @include('requestDate')
        ...
        <div class="col-lg-12 text-right mb-2">
            ...
            @if (auth()->guard('admin')->user()->can(['export-all-transaction']))
                @if (!empty($subQueryString))
                    <a href="{{ route('all-admin-declined-transactions-csv-export', [$subQueryString]) }}"
                        class="btn btn-primary"><i class="fa fa-download"></i> Export Excel </a>
                @else
                    <a href="{{ route('all-admin-declined-transactions-csv-export') }}" class="btn btn-primary"
                        id="ExcelLink">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="header-title">
                        <h4 class="card-title">Declined Transactions</h4>
                    </div>
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.declined.transactions') }}" class="btn btn-danger btn-sm"
                                        ...
                                        <tr id="tr_{{ $transaction->id }}">
                                            ...
                                            <td>
                                                ...
                                                @if ($transaction->is_white_label)
                                                    <label class="badge badge-success badge-sm">WTL</label>
                                                @else
                                                    <label class="badge badge-success badge-sm">FT</label>
                                                @endif
                                            </td>
                                            <td>
