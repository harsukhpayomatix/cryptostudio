...
@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / Crypto Transactions
@endsection
        ...
        <div class="col-lg-12 text-right mb-2">
            @if (auth()->guard('admin')->user()->can(['export-all-transaction']))
                @if (!empty($subQueryString))
                    <a href="{{ route('all-admin-crypto-transactions-csv-export', [$subQueryString]) }}"
                        class="btn btn-primary"><i class="fa fa-download"></i> Export Excel </a>
                @else
                    <a href="{{ route('all-admin-crypto-transactions-csv-export') }}" class="btn btn-primary"
                        id="ExcelLink">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="header-title">
                        <h4 class="card-title">Crypto Transaction</h4>
                    </div>
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('crypto') }}" class="btn btn-danger btn-sm"
                                        ...
                                        <tr id="tr_{{ $transaction->id }}">
                                            ...
                                            <td>
                                                ...
                                                @elseif($transaction->status == '4')
                                                    <label class="badge-sm badge badge-primary">To Be Confirm</label>
                                                @else
