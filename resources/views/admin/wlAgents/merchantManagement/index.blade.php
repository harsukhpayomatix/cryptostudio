...
@section('title')
    White Label RP Merchant Management
@endsection
                ...
                <div class="card-header">
                    ...
                    <div>
                        <div class="btn-group">
                            ...
                            <a href="{!! URL::route('wl-agent-merchant', request()->route('id')) !!}" class="btn btn-danger btn-sm"
                                style="border-radius: 0px 5px 5px 0px !important;">Reset</a>
                        </div>
                        @if (auth()->guard('admin')->user()->can(['wl-rp-merchant-create']))
                            <a href="{{ route('wl-agent-merchant-create', request()->route('id')) }}"
                                class="btn btn-primary btn-sm" id="new_merchant"><i class="fa fa-plus"></i> Create
                                Merchant
                            </a>
                        @endif
                        @if (auth()->guard('admin')->user()->can(['export-wl-rp-merchant']))
                            <a href="javascript:;" data-link="{!! route('wl-agent-merchant-export', [request()->route('id')] + request()->all()) !!}"
                                data-filename="White_Label_RP_Merchant_Excel_" class="btn btn-danger btn-sm"
                                            ...
                                            <td>
                                                <div class="custom-control form-check custom-control-inline mr-0">
                                                    <input type="checkbox"
                                                        ...
                                                        name="multicheckmail[]" id="checkbox"
                                                        value="{{ $data->id }}">
