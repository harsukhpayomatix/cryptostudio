            ...
            @if (auth()->guard('admin')->user()->can(['users-bank-excel-export']))
                ...
                @if (!empty($subQueryString))
                    <a href="{{ route('bank-user-csv-export', [$subQueryString]) }}"
                        class="btn btn-primary btn-sm btn-shadow" id="ExcelLink"><i class="fa fa-download"></i> Export
                        Excel </a>
                @else
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        @if (auth()->guard('admin')->user()->can(['users-bank-create']))
                            <a href="{{ url('admin/banks/create') }}" class="btn btn-danger btn-sm"> Create Bank</a>
                        @endif
                    </div>
                </div>
