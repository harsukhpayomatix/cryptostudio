        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card  mt-1">
                <div class="card-header">
                    <h4 class="card-title">Edit Bank User</h4>
                    <a href="{{ route('banks.index') }}" class="btn btn-primary btn-sm rounded"> <i class="fa fa-arrow-left"
                            aria-hidden="true"></i></a>
                </div>
                <div class="card-body">
                    {{ Form::model($data, ['route' => ['banks.update', $data->id], 'method' => 'patch', 'id' => 'agent-form', 'class' => 'form-dark']) }}
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-div">
                                    {!! Form::select('category_id[]', $category, isset($data->category_id) ? explode(',', $data->category_id) : [], [
                                        'id' => 'category_id',
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-0">
                                    <label class="form-check-label mr-3"><input type="radio" id="rdo-1"
                                            ...
                                            @if ($data->is_active == '1' || $data->is_active == null) checked @endif> Active</label>
                                    <label class="form-check-label mr-3"><input type="radio" id="rdo-2"
                                            name="is_active" class="form-check-input" value="0"
                                            @if ($data->is_active == '0' || $data->is_active == null) checked @endif> Inactive</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <label class="form-check-label mr-3"><input type="radio" id="rdo-4"
                                            ...
                                            @if ($data->is_otp_required == '0') checked @endif>
                                        No</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Extra Email<br>
                                    {!! Form::text('extra_email', isset($data->extra_email) ? implode(',', json_decode($data->extra_email)) : null, [
                                        'placeholder' => 'Enter here',
                                        'class' => 'multi-select',
                                        'id' => 'input-tags',
                                        'multiple' => 'multiple',
                                    ]) !!}
                                    <small>Press <kbd class="badge-primary">Tab</kbd> after each email input and <kbd
                                            class="badge-primary">left/right arrow keys</kbd>
