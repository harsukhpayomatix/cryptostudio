        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="right" style="color: #F94687; font-weight: 900;">{{ round($value->retrieval_transaction_sum, 2) }}</td>
                </tr>
                @if($value->remove_past_retrieval > 0)
                <tr>
                    <td>Remove Retrieval</td>
                    <td>{{ number_format($value->remove_past_retrieval, 0) }}</td>
                    <td class="right" style="color: green; font-weight: 900;">{{ round($value->past_retrieval_sum, 2) }}</td>
                </tr>
                @endif
                <tr class="bluebg">
