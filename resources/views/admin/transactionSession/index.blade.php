                        ...
                        <div class="basic-form">
                            <div class="row ">
                                    ...
                                    <select class="form-control select2" name="company_name">
                                        ...
                                        @foreach ($company_name as $value)
                                            <option value="{{ $value->user_id }}"
                                                {{ isset($_GET['company_name']) && $_GET['company_name'] == $value->user_id ? 'selected' : '' }}
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="is_completed" class="form-control select2" data-width="100%">
                                        <option disabled selected> -- Status -- </option>
                                        <option value="1"
                                            {{ isset($_GET['is_completed']) && $_GET['is_completed'] == '1' ? 'selected' : '' }}>
                                            Completed</option>
                                        <option value="0"
                                            {{ isset($_GET['is_completed']) && $_GET['is_completed'] == '0' ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="name">Gateway ID</label>
                                    <input type="text" class="form-control" placeholder="Gateway ID" name="gateway_id"
                                        value="{{ $_GET['gateway_id'] ?? '' }}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="name">Session ID</label>
                                    <input type="text" class="form-control" placeholder="Session ID" name="session_id"
                                        value="{{ $_GET['session_id'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('transaction-session') }}" class="btn btn-danger btn-sm"
