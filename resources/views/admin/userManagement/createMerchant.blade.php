        ...
        <div class="col-lg-12">
            <div class="card  mt-1">
                <div class="card-header">
                    ...
                    <a href="{{ route('users-management') }}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i>
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('merchant-user-store') }}" method="post" class="form-dark">
                        ...
                        <div class="row">
                                ...
                                <div class="main-select-phone d-flex justify-content-between align-items-center">
                                    <select class="select2 btn-primary fill_selectbtn_in own_selectbox" name="country_code"
                                        ...
                                        <option data-countryCode="BM"
                                            {{ old('country_code') == '1441' ? 'selected' : '' }} value="1441">
                                            Bermuda (+1441)</option>
                                        ...
                                        <option data-countryCode="KY"
                                            {{ old('country_code') == '1345' ? 'selected' : '' }} value="1345">
                                        ...
                                        <option data-countryCode="CY"
                                            {{ old('country_code') == '90392' ? 'selected' : '' }} value="90392">
                                        ...
                                        <option data-countryCode="DM"
                                            {{ old('country_code') == '1767' ? 'selected' : '' }} value="1767">
                                            Dominica (+1767)</option>
                                        <option data-countryCode="DO"
                                            {{ old('country_code') == '1809' ? 'selected' : '' }} value="1809">
                                        ...
                                        <option data-countryCode="GD"
                                            {{ old('country_code') == '1473' ? 'selected' : '' }} value="1473">
                                            Grenada (+1473)</option>
                                        ...
                                        <option data-countryCode="IQ"
                                            {{ old('country_code') == '964' ? 'selected' : '' }} value="964">
                                            Iraq
                                            (+964)</option>
                                        <option data-countryCode="IE"
                                            {{ old('country_code') == '353' ? 'selected' : '' }} value="353">
                                            Ireland (+353)</option>
                                        <option data-countryCode="IL"
                                            {{ old('country_code') == '972' ? 'selected' : '' }} value="972">
                                            Israel (+972)</option>
                                        ...
                                        <option data-countryCode="JM"
                                            {{ old('country_code') == '1876' ? 'selected' : '' }} value="1876">
                                            Jamaica (+1876)</option>
                                        ...
                                        <option data-countryCode="JO"
                                            {{ old('country_code') == '962' ? 'selected' : '' }} value="962">
                                            Jordan (+962)</option>
                                        <option data-countryCode="KZ" {{ old('country_code') == '7' ? 'selected' : '' }}
                                            value="7">
                                            Kazakhstan (+7)</option>
                                        <option data-countryCode="KE"
                                            {{ old('country_code') == '254' ? 'selected' : '' }} value="254">
                                            Kenya
                                            (+254)</option>
                                        <option data-countryCode="KI"
                                            {{ old('country_code') == '686' ? 'selected' : '' }} value="686">
                                            Kiribati (+686)</option>
                                        <option data-countryCode="KP"
                                            {{ old('country_code') == '850' ? 'selected' : '' }} value="850">
                                            Korea
                                            North (+850)</option>
                                        ...
                                        <option data-countryCode="KW"
                                            {{ old('country_code') == '965' ? 'selected' : '' }} value="965">
                                            Kuwait (+965)</option>
                                        <option data-countryCode="KG"
                                            {{ old('country_code') == '996' ? 'selected' : '' }} value="996">
                                            Kyrgyzstan (+996)</option>
                                        <option data-countryCode="LA"
                                            {{ old('country_code') == '856' ? 'selected' : '' }} value="856">
                                            Laos
                                            (+856)</option>
                                        <option data-countryCode="LV"
                                            {{ old('country_code') == '371' ? 'selected' : '' }} value="371">
                                            Latvia (+371)</option>
                                        <option data-countryCode="LB"
                                            {{ old('country_code') == '961' ? 'selected' : '' }} value="961">
                                            Lebanon (+961)</option>
                                        <option data-countryCode="LS"
                                            {{ old('country_code') == '266' ? 'selected' : '' }} value="266">
                                            Lesotho (+266)</option>
                                        <option data-countryCode="LR"
                                            {{ old('country_code') == '231' ? 'selected' : '' }} value="231">
                                            Liberia (+231)</option>
                                        <option data-countryCode="LY"
                                            {{ old('country_code') == '218' ? 'selected' : '' }} value="218">
                                            Libya
                                            (+218)</option>
                                        <option data-countryCode="LI"
                                            {{ old('country_code') == '417' ? 'selected' : '' }} value="417">
                                            Liechtenstein (+417)</option>
                                        <option data-countryCode="LT"
                                            {{ old('country_code') == '370' ? 'selected' : '' }} value="370">
                                            Lithuania (+370)</option>
                                        <option data-countryCode="LU"
                                            {{ old('country_code') == '352' ? 'selected' : '' }} value="352">
                                            Luxembourg (+352)</option>
                                        <option data-countryCode="MO"
                                            {{ old('country_code') == '853' ? 'selected' : '' }} value="853">
                                            Macao
                                            (+853)</option>
                                        <option data-countryCode="MK"
                                            {{ old('country_code') == '389' ? 'selected' : '' }} value="389">
                                            Macedonia (+389)</option>
                                        <option data-countryCode="MG"
                                            {{ old('country_code') == '261' ? 'selected' : '' }} value="261">
                                            Madagascar (+261)</option>
                                        <option data-countryCode="MW"
                                            {{ old('country_code') == '265' ? 'selected' : '' }} value="265">
                                            Malawi (+265)</option>
                                        <option data-countryCode="MY" {{ old('country_code') == '60' ? 'selected' : '' }}
                                            value="60">
                                            Malaysia (+60)</option>
                                        <option data-countryCode="MV"
                                            {{ old('country_code') == '960' ? 'selected' : '' }} value="960">
                                            Maldives (+960)</option>
                                        <option data-countryCode="ML"
                                            {{ old('country_code') == '223' ? 'selected' : '' }} value="223">
                                            Mali
                                            (+223)</option>
                                        <option data-countryCode="MT"
                                            {{ old('country_code') == '356' ? 'selected' : '' }} value="356">
                                            Malta
                                            (+356)</option>
                                        <option data-countryCode="MH"
                                            {{ old('country_code') == '692' ? 'selected' : '' }} value="692">
                                            Marshall Islands (+692)</option>
                                        <option data-countryCode="MQ"
                                            {{ old('country_code') == '596' ? 'selected' : '' }} value="596">
                                            Martinique (+596)</option>
                                        <option data-countryCode="MR"
                                            {{ old('country_code') == '222' ? 'selected' : '' }} value="222">
                                            Mauritania (+222)</option>
                                        <option data-countryCode="YT"
                                            {{ old('country_code') == '269' ? 'selected' : '' }} value="269">
                                            Mayotte (+269)</option>
                                        ...
                                        <option data-countryCode="FM"
                                            {{ old('country_code') == '691' ? 'selected' : '' }} value="691">
                                            Micronesia (+691)</option>
                                        <option data-countryCode="MD"
                                            {{ old('country_code') == '373' ? 'selected' : '' }} value="373">
                                            Moldova (+373)</option>
                                        <option data-countryCode="MC"
                                            {{ old('country_code') == '377' ? 'selected' : '' }} value="377">
                                            Monaco (+377)</option>
                                        <option data-countryCode="MN"
                                            {{ old('country_code') == '976' ? 'selected' : '' }} value="976">
                                            Mongolia (+976)</option>
                                        <option data-countryCode="MS"
                                            {{ old('country_code') == '1664' ? 'selected' : '' }} value="1664">
                                            Montserrat (+1664)</option>
                                        <option data-countryCode="MA"
                                            {{ old('country_code') == '212' ? 'selected' : '' }} value="212">
                                            Morocco (+212)</option>
                                        <option data-countryCode="MZ"
                                            {{ old('country_code') == '258' ? 'selected' : '' }} value="258">
                                        ...
                                        <option data-countryCode="NA"
                                            {{ old('country_code') == '264' ? 'selected' : '' }} value="264">
                                            Namibia (+264)</option>
                                        <option data-countryCode="NR"
                                            {{ old('country_code') == '674' ? 'selected' : '' }} value="674">
                                            Nauru
                                            (+674)</option>
                                        <option data-countryCode="NP"
                                            {{ old('country_code') == '977' ? 'selected' : '' }} value="977">
                                            Nepal
                                            (+977)</option>
                                        ...
                                        <option data-countryCode="NC"
                                            {{ old('country_code') == '687' ? 'selected' : '' }} value="687">
                                            New
                                        ...
                                        <option data-countryCode="NI"
                                            {{ old('country_code') == '505' ? 'selected' : '' }} value="505">
                                            Nicaragua (+505)</option>
                                        <option data-countryCode="NE"
                                            {{ old('country_code') == '227' ? 'selected' : '' }} value="227">
                                            Niger
                                            (+227)</option>
                                        <option data-countryCode="NG"
                                            {{ old('country_code') == '234' ? 'selected' : '' }} value="234">
                                            Nigeria (+234)</option>
                                        <option data-countryCode="NU"
                                            {{ old('country_code') == '683' ? 'selected' : '' }} value="683">
                                            Niue
                                            (+683)</option>
                                        <option data-countryCode="NF"
                                            {{ old('country_code') == '672' ? 'selected' : '' }} value="672">
                                            Norfolk Islands (+672)</option>
                                        <option data-countryCode="NP"
                                            {{ old('country_code') == '670' ? 'selected' : '' }} value="670">
                                        ...
                                        <option data-countryCode="OM"
                                            {{ old('country_code') == '968' ? 'selected' : '' }} value="968">
                                            Oman
                                            (+968)</option>
                                        <option data-countryCode="PW"
                                            {{ old('country_code') == '680' ? 'selected' : '' }} value="680">
                                            Palau
                                            (+680)</option>
                                        <option data-countryCode="PA"
                                            {{ old('country_code') == '507' ? 'selected' : '' }} value="507">
                                            Panama (+507)</option>
                                        <option data-countryCode="PG"
                                            {{ old('country_code') == '675' ? 'selected' : '' }} value="675">
                                            Papua
                                            New Guinea (+675)</option>
                                        <option data-countryCode="PY"
                                            {{ old('country_code') == '595' ? 'selected' : '' }} value="595">
                                            Paraguay (+595)</option>
                                        ...
                                        <option data-countryCode="PT"
                                            {{ old('country_code') == '351' ? 'selected' : '' }} value="351">
                                            Portugal (+351)</option>
                                        <option data-countryCode="PR"
                                            {{ old('country_code') == '1787' ? 'selected' : '' }} value="1787">
                                            Puerto Rico (+1787)</option>
                                        <option data-countryCode="QA"
                                            {{ old('country_code') == '974' ? 'selected' : '' }} value="974">
                                            Qatar
                                            (+974)</option>
                                        <option data-countryCode="RE"
                                            {{ old('country_code') == '262' ? 'selected' : '' }} value="262">
                                            Reunion (+262)</option>
                                        ...
                                        <option data-countryCode="RW"
                                            {{ old('country_code') == '250' ? 'selected' : '' }} value="250">
                                            Rwanda (+250)</option>
                                        <option data-countryCode="SM"
                                            {{ old('country_code') == '378' ? 'selected' : '' }} value="378">
                                            San
                                            Marino (+378)</option>
                                        <option data-countryCode="ST"
                                            {{ old('country_code') == '239' ? 'selected' : '' }} value="239">
                                            Sao
                                            Tome &amp; Principe (+239)</option>
                                        <option data-countryCode="SA"
                                            {{ old('country_code') == '966' ? 'selected' : '' }} value="966">
                                            Saudi
                                            Arabia (+966)</option>
                                        <option data-countryCode="SN"
                                            {{ old('country_code') == '221' ? 'selected' : '' }} value="221">
                                            Senegal (+221)</option>
                                        <option data-countryCode="CS"
                                            {{ old('country_code') == '381' ? 'selected' : '' }} value="381">
                                            Serbia (+381)</option>
                                        <option data-countryCode="SC"
                                            {{ old('country_code') == '248' ? 'selected' : '' }} value="248">
                                            Seychelles (+248)</option>
                                        <option data-countryCode="SL"
                                            {{ old('country_code') == '232' ? 'selected' : '' }} value="232">
                                            Sierra Leone (+232)</option>
                                        <option data-countryCode="SG" {{ old('country_code') == '65' ? 'selected' : '' }}
                                            value="65">
                                            Singapore (+65)</option>
                                        <option data-countryCode="SK"
                                            {{ old('country_code') == '421' ? 'selected' : '' }} value="421">
                                            Slovak Republic (+421)</option>
                                        <option data-countryCode="SI"
                                            {{ old('country_code') == '386' ? 'selected' : '' }} value="386">
                                            Slovenia (+386)</option>
                                        <option data-countryCode="SB"
                                            {{ old('country_code') == '677' ? 'selected' : '' }} value="677">
                                            Solomon Islands (+677)</option>
                                        <option data-countryCode="SO"
                                            {{ old('country_code') == '252' ? 'selected' : '' }} value="252">
                                            Somalia (+252)</option>
                                        ...
                                        <option data-countryCode="SH"
                                            {{ old('country_code') == '290' ? 'selected' : '' }} value="290">
                                            St.
                                            Helena (+290)</option>
                                        <option data-countryCode="KN"
                                            {{ old('country_code') == '1869' ? 'selected' : '' }} value="1869">
                                            St.
                                            Kitts (+1869)</option>
                                        <option data-countryCode="SC"
                                            {{ old('country_code') == '1758' ? 'selected' : '' }} value="1758">
                                            St.
                                            Lucia (+1758)</option>
                                        <option data-countryCode="SD"
                                            {{ old('country_code') == '249' ? 'selected' : '' }} value="249">
                                            Sudan
                                            (+249)</option>
                                        <option data-countryCode="SR"
                                            {{ old('country_code') == '597' ? 'selected' : '' }} value="597">
                                            Suriname (+597)</option>
                                        <option data-countryCode="SZ"
                                            {{ old('country_code') == '268' ? 'selected' : '' }} value="268">
                                        ...
                                        <option data-countryCode="SI"
                                            {{ old('country_code') == '963' ? 'selected' : '' }} value="963">
                                            Syria
                                            (+963)</option>
                                        <option data-countryCode="TW"
                                            {{ old('country_code') == '886' ? 'selected' : '' }} value="886">
                                            Taiwan (+886)</option>
                                        <option data-countryCode="TJ"
                                            {{ old('country_code') == '992' ? 'selected' : '' }} value="992">
                                            Tajikstan (+992)</option>
                                        <option data-countryCode="TH" {{ old('country_code') == '66' ? 'selected' : '' }}
                                            value="66">
                                            Thailand (+66)</option>
                                        <option data-countryCode="TG"
                                            {{ old('country_code') == '228' ? 'selected' : '' }} value="228">
                                            Togo
                                            (+228)</option>
                                        <option data-countryCode="TO"
                                            {{ old('country_code') == '676' ? 'selected' : '' }} value="676">
                                            Tonga
                                            (+676)</option>
                                        <option data-countryCode="TT"
                                            {{ old('country_code') == '1868' ? 'selected' : '' }} value="1868">
                                            Trinidad &amp; Tobago (+1868)</option>
                                        <option data-countryCode="TN"
                                            {{ old('country_code') == '216' ? 'selected' : '' }} value="216">
                                            Tunisia (+216)</option>
                                        ...
                                        <option data-countryCode="TM"
                                            {{ old('country_code') == '993' ? 'selected' : '' }} value="993">
                                            Turkmenistan (+993)</option>
                                        <option data-countryCode="TC"
                                            {{ old('country_code') == '1649' ? 'selected' : '' }} value="1649">
                                            Turks &amp; Caicos Islands (+1649)</option>
                                        <option data-countryCode="TV"
                                            {{ old('country_code') == '688' ? 'selected' : '' }} value="688">
                                            Tuvalu (+688)</option>
                                        <option data-countryCode="UG"
                                            {{ old('country_code') == '256' ? 'selected' : '' }} value="256">
                                            Uganda (+256)</option>
                                        ...
                                        <option data-countryCode="UY"
                                            {{ old('country_code') == '598' ? 'selected' : '' }} value="598">
                                            Uruguay (+598)</option>
                                        <option data-countryCode="UZ"
                                            {{ old('country_code') == '998' ? 'selected' : '' }} value="998">
                                            Uzbekistan (+998)</option>
                                        <option data-countryCode="VU"
                                            {{ old('country_code') == '678' ? 'selected' : '' }} value="678">
                                            Vanuatu (+678)</option>
                                        <option data-countryCode="VA"
                                            {{ old('country_code') == '379' ? 'selected' : '' }} value="379">
                                        ...
                                        <option data-countryCode="WF"
                                            {{ old('country_code') == '681' ? 'selected' : '' }} value="681">
                                            Wallis &amp; Futuna (+681)</option>
                                        <option data-countryCode="YE"
                                            {{ old('country_code') == '969' ? 'selected' : '' }} value="969">
                                            Yemen
                                            (North)(+969)</option>
                                        <option data-countryCode="YE"
                                            {{ old('country_code') == '967' ? 'selected' : '' }} value="967">
                                            Yemen
                                            (South)(+967)</option>
                                        <option data-countryCode="ZM"
                                            {{ old('country_code') == '260' ? 'selected' : '' }} value="260">
                                            Zambia (+260)</option>
                                        <option data-countryCode="ZW"
                                            {{ old('country_code') == '263' ? 'selected' : '' }} value="263">
                                            Zimbabwe (+263)</option>
                                    </select>
                            ...
                            <div class="form-group col-lg-6">
                                <label for="">Whitelable Merchant</label>
                                <div class="basic-form">
                                    <div class="form-group mb-0">
                                        <label class="form-check-label mr-3">
                                            <input type="radio" name="is_whitelable"
                                                class="form-check-input md-radiobtn" value="0" checked="checked">
                                            No
                                        </label>
                                        <label class="form-check-label mr-3">
                                            <input type="radio" name="is_whitelable"
                                                class="form-check-input md-radiobtn" value="1">
                                            Yes
                                        </label>
                                    </div>
                                </div>
                                @if ($errors->has('is_whitelable'))
                                    <span class="help-block font-red-mint text-danger">
                                        <span>{{ $errors->first('is_whitelable') }}</span>
                                    </span>
                                @endif
                            </div>
