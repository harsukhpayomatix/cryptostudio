                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ url('admin/users-management') }}" class="btn btn-danger btn-sm"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @if (auth()->guard('admin')->user()->can(['merchant-assign-mid']))
                                                            ...
                                                            @endif
                                                        @endif
                                                        @if (auth()->guard('admin')->user()->can(['merchant-view-bank-details']))
                                                            <a href="{{ route('admin.merchant.bankDetails', $data->id) }}"
                                                                class="user-show dropdown-item"><i
