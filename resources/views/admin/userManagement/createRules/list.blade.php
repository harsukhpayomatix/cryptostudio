            ...
            <div class="card  mt-1">
                <div class="card-header">
                    ...
                    @if (auth()->guard('admin')->user()->can(['create-rule']))
                        <a href="{{ route('merchant.create_rules.create', ['id' => $id, 'type' => $type]) }}"
                            class="btn btn-primary btn-sm">Create Rules</a>
                    @endif
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="assignMIDContent">
                    <form id="assignMIDForm" class="form-dark">
                        @csrf
                        <select class="select2" id="assignMID" name="assignMID" style="display:none">
                            <option value="" disabled>--Select MID--</option>
...
@section('customScript')
    ...
    <script type="text/javascript">
        ...
        $('#rules_List').DataTable({
            dragColumn: true,
            ajax: {
                url: '{{ route('merchant.rules.datatable') }}',
                type: "post",
                data: function(d) {
