...
<body style="height: 100%; background-color: #2B2B2B;font-family: 'Nunito', sans-serif;width: 100%;margin: auto;">
    <main>
        <table style="padding: 30px 60px 0px 60px; width: 100%;">
            ...
            <tr>
                <td style="background: #2B2B2B; border-radius: 5px 5px 0px 0px; padding: 30px;">
        ...
        <table style="background-color: #FFF; border-top: 3px solid #34383e; width: 100%; padding: 15px 60px 0px 60px;">
            <tr>
