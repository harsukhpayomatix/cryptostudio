...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
      <p>A retrieval has been raised on a transaction made with the card details listed below. Please submit the card
        holder's
        KYC documentation and relevant transaction details via the link below within 72 hours.</p><br>
      <table border="0" cellpadding="5" cellspacing="0"
        ...
        <tbody>
          ...
          <tr>
            <td>
              <p><strong>Retrival Date</strong></p>
            </td>
            <td>
      ...
      <br />
      <p>
        Failure to provide readable documentation may result in cancellation of the transaction and your account being
        charged.
        You can submit receipts, invoices, registration forms, signed transaction receipts, delivery notes, customer
        contact
        information, and a copy of the card used (with intermediate digits masked).
      </p>
    </td>
  </tr>
</table>
...
<p style="font-weight: bold; line-height: 16px;"><small>
    Please upload the following documents for the retrieval request:<br>
