@component('mail::message')
    ...
    <table cellpadding="5" cellspacing="0"
        ...
        <thead style="background-color: #262626; color: #B3ADAD; font-size: 18px; font-weight: bold;padding:5px;">
            <tr>
                <td>APM</td>
                <td>Rates %</td>
            </tr>
        ...
        <tbody style="font-size: 16px;padding: 5px;">
            @foreach ($userApms as $index => $userApm)
                <tr style="background-color: {{ $index % 2 == 0 ? '#1C1C1C' : '#2B2B2B' }}; color: #B3ADAD;">
                    <td>
