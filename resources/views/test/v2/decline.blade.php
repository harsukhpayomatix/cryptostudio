...
<head>
    ...
    <title>{{ config('app.name') }} | {{ __('messages.pageTitleCrytoDeclinedTest') }}</title>
                ...
                <div class="col-md-4 col-xl-4 col-xxl-4">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="text-primary">{{ __('messages.subHeadingTest') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mt-2">
                                <div class="card-body gateway-card">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <h3 class="text-primary">{{ __('messages.txnDeclined') }}</h3>
                                            <p class="mb-0">{{ $input['reason'] }}</p>
                                        </div>

                                        <div class="col-md-12 mt-1">
                                            <a href="{{ route('api.v2.test-checkout', $input['order_id']) }}"
                                                class="btn btn-primary w-100">{{ __('messages.retryWithNewMethod') }}</a>
                                        </div>
                                        <div class="col-md-12 mt-1">
                                            <a href="{{ route('api.v2.test-redirect', $input['order_id']) }}"
