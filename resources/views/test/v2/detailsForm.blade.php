<div class="row">
    ...
    @if (in_array('address', $data) ||
        ...
        <div class="col-sm-12 col-md-{!! $billing_md !!}">
            <div class="row">
                <h4 class="text-primary">{{ __('messages.billingDetails') }}</h4>
                @if (in_array('address', $data))
                ...
                @if (in_array('city', $data))
                    <div class="col-md-12 form-group mb-1">
                        ...
                        <input class="form-control required-field" name="city" type="text" id="city"
                            placeholder="{{ __('messages.city') }}" value="{{ $input['city'] ?? null }}"
                            minlength="2" maxlength="50" required data-missing="City field is required">
                        @if ($errors->has('city'))
                            <span class="help-block">
                ...
                @if (in_array('state', $data))
                    <div class="col-md-12 form-group mb-1">
                        ...
                        <input type="text" name="state" placeholder="{{ __('messages.state') }}" id="state"
                            class="form-control required-field" value="{{ $input['state'] ?? null }}"detailsForm
                            required data-missing="State field is required">
                        @if ($errors->has('state'))
                            <span class="help-block">
            ...
            <div class="pd-25">
                ...
                <div class="form-group mb-1">
                    ...
                    <div class="input-group">
                        <input type="text" name="card_no" placeholder="{{ __('messages.cardNo') }}"
                            class="form-control inputCreditCard fld-txt required-field-input required-field"
                            id="card" value="{{ $input['card_no'] ?? null }}" required
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    <label>{{ __('messages.cardExpiryMonth') }}</label>
                                    <select class="expiration-month form-control fld-txt required-field"
                                        name="ccExpiryMonth" required
                                        data-missing="Card Expiry Month field is required">
                                        <option value="01"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    <label>{{ __('messages.cardExpiryYear') }}</label>
                                    <select class="expiration-year form-control fld-txt required-field"
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-1">
                            ...
                            <small class="sm-right" data-toggle="tooltip" data-placement="top"
