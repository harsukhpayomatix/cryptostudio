...
<head>
    ...
    <title>{{ config('app.name') }} | {{ __('messages.pageTitleTestCrypto') }}</title>
...
<body>
                        ...
                        <div class="col-md-12">
                            <div class="card mt-2">
                                <div class="card-body gateway-card">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <p class="text-danger">{{ __('messages.payWithYourCrypto') }}</p>
                                        ...
                                        <div class="col-md-12">
                                            <form action="{{ route('api.v2.test-cryptoSubmit', $order_id) }}"
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#submit-button', function(e) {
            ...
            $.ajax({
                url: '{{ route('api.v2.test-cryptoSubmit', $order_id) }}',
                type: 'post',
                data: data,
                beforeSend: function() {
