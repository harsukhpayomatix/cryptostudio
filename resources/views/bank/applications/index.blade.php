...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            <form action="{{ route('bank.applications.exportAllApplications', request()->all()) }}" method="POST">
                @csrf
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('bank.applications') }}" class="btn btn-danger btn-sm"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @if ($value->app_status != 2)
                                                            <a href="#declinedModel" data-bs-toggle="modal"
                                                        ...
                                                        @endif
                                                        @if ($value->app_status == 0)
                                                            <a href="#referredModel" data-bs-toggle="modal"
