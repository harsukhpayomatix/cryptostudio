			...
			<div class="table-responsive custom-table">
            	<table class="table table-borderless table-striped">
					...
					<tr>
						...
						<td>
							<a href="{{ getS3Url($data->licence_document) }}" target="_blank" class="btn btn-primary btn-sm">Show</a>
					...
					<tr>
						...
						<td>
							...
							<div class="col-md-12">
								...
								<div class="col-md-8">
									<a href="{{ getS3Url($value) }}" target="_blank" class="btn btn-primary btn-sm">Show</a>
					...
					<tr>
						...
						<td>
							<a href="{{ getS3Url($data->moa_document) }}" target="_blank" class="btn btn-primary btn-sm">Show</a>
