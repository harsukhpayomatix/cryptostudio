...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="mt-50">Pending Application List</h4>
        </div>
        <div class="col-md-6 text-right">
            <form action="{{ route('bank.applications.exportPendingApplications', request()->all()) }}" method="POST">
                @csrf
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('bank.applications.pending') }}" class="btn btn-danger btn-sm"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item approved" title="Approve Application"
                                                            ...
                                                            data-link="{{ route('application-approved') }}">
                                                            Approve
                                                        </a>
                                                        ...
                                                        <a href="#referredModel" data-toggle="modal"
                                                            class="dropdown-item" id="referred"
                                                            title="Referred Application" data-id="{{ $value->id }}"
                                                            data-current_users_id="{{ auth()->guard('bankUser')->user()->id }}">
                                                            Referred
                                                        </a>
    ...
    @include('bank.applications.partials.referred_model')
@endsection
