...
<div class="row">
    <div class="col-lg-4 mb-2">
        <div class="merchantTxnCard">
            ...
            <p class="total">Total Count : <span style="color: #4F738E;"> {{ count($application) }}</span></p>
        </div>
    </div>
    <div class="col-lg-4 mb-2">
        <div class="merchantTxnCard">
            ...
            <p class="total">Total Count : <span style="color: #4F738E;"> {{ count($application->where('status','1')) }}</span></p>
        </div>
    </div>
    <div class="col-lg-4 mb-2">
        <div class="merchantTxnCard">
            ...
            <p class="total">Total Count : <span style="color: #4F738E;"> {{ count($application->where('status','2')) }}</span></p>
        </div>
    </div>
</div>	
@endsection