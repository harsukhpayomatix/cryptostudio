                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-9 col-md-9">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input form-control" id="validationCustomFile1" name="passport[]" Required>
                                        </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-9 col-md-9">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input form-control" id="validationCustomFile2" name="latest_bank_account_statement[]" Required>
                                        </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-9 col-md-9">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input form-control" id="validationCustomFile3" name="utility_bill[]" Required>
                                        </div>
                                        <div class="dynamicUtilityBillFields"></div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-9 col-md-9">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input form-control" id="validationCustomFile4" name="company_incorporation_certificate" Required>
                                        </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-9 col-md-9">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input form-control" id="validationCustomFile5" name="article_of_accociasion">   
                                        </div>
                                        <div class="dynamicCertificateOfIncorporationFields"></div>
