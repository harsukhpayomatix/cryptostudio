...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="mt-50">Refund Transactions</h4>
        </div>
        <div class="col-md-6 text-right">
            @if (!empty($subQueryString))
                <a href="{{ route('bank-merchant-refund-transactions', ['type' => 'xlsx'] + request()->all(), [$subQueryString]) }}"
                    class="btn btn-primary" id="ExcelLink"><i class="fa fa-download"></i> Export Excel</a>
            @else
                <a href="{{ route('bank-merchant-refund-transactions', ['type' => 'xlsx'] + request()->all()) }}"
                    class="btn btn-primary" id="ExcelLink"><i class="fa fa-download"></i> Export Excel</a>
            @endif
        </div>
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('bank-merchant-refund-transactions') }}" class="btn btn-danger btn-sm"
