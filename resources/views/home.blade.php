        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="merchantTxnCard">
                    ...
                    <p class="total">Total Count : <span style="color: #4F738E;"> {{ $transaction->successfullC }}</span></p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="merchantTxnCard">
                    ...
                    <p class="total">Total Count : <span style="color: #4F738E;"> {{$transaction->declinedC}}</span></p>
                </div>
            </div>
            <div class="col-lg-6 mb-2 mt-2">
                <div class="merchantTxnCard">
                    ...
                    <p class="total">Total Count : <span style="color: #4F738E;"> {{ $transaction->suspiciousC }}</span></p>
                </div>
            </div>
            <div class="col-lg-6 mb-2 mt-2">
                <div class="merchantTxnCard">
                    ...
                    <p class="total">Total Count : <span style="color: #4F738E;"> {{ $transaction->refundC }}</span></p>
                </div>
            </div>
        </div>
    </div>
