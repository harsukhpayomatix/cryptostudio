...
@section('breadcrumbTitle')
    <a href="{{ route('dashboardPage') }}">Dashboard</a> / Chargebacks Transactions
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="mt-50">Chargebacks Transactions List</h4>
        </div>
        <div class="col-md-6 text-right">
            <form action="{{ route('chargebacks.export', request()->all()) }}" method="POST">
                @csrf
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('chargebacks') }}" class="btn btn-danger btn-sm"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="{{ route('transaction.show', ['id' => $transaction->id]) }}"
                                                            ...
                                                            Show</a>
                                                        <a href="javascript:;"
                                                            class="chargebacks-show-documents dropdown-item"
                                                            data-bs-target="#transactionShowModal" data-bs-toggle="modal"
                                                            data-id="{{ $transaction->id }}"
                                                            data-link="{{ route('chargebacks-showdocument') }}">Show Documents
                                                        </a>
