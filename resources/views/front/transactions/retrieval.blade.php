...
@section('breadcrumbTitle')
    <a href="{{ route('dashboardPage') }}">Dashboard</a> / Retrieval Transactions
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="mt-50">Retrieval Transactions List</h4>
        </div>
        <div class="col-md-6 text-right">
            <form method="POST" action="{{ route('retrieval.export', request()->all()) }}">
                @csrf
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('retrieval') }}" class="btn btn-danger btn-sm"
