...
@section('breadcrumbTitle')
    <a href="{{ route('dashboardPage') }}">Dashboard</a> / Refund Transactions
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="mt-50">Refund Transactions List</h4>
        </div>
        <div class="col-md-6 text-right">
            <form action="{{ route('refunds.export', request()->all()) }}" method="POST">
                @csrf
                <button type="submit" data-filename="Refund_Transaction_Excel_" class="btn btn-primary"><i
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('refunds') }}" class="btn btn-danger btn-sm"
                                        ...
                                        <tr id="tr_{{ $transaction->id }}">
                                            ...
                                            <td>
                                                ...
                                                @elseif($transaction->is_request_from_vt == 'WEBHOOK')
                                                    <label class="light badge badge-sm badge-primary">WEBHOOK</label>
                                                @endif
