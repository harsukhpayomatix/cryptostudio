    ...
    "data": {
        ...
        "client": {
            ...
            "country": "GB"
                        ...
                        <pre>{{ config('app.url') }}?responseCode=1&responseMessage=Test%20transaction%20processed%20successfully.&order_id=ODRDX3Y1683876328LBIJA1&customer_order_id=TX121212</pre>
                        ...
                        <pre>{{ config('app.url') }}?responseCode=0&responseMessage=Card%not%supported%for%testing.&order_id=ODRDX3Y1683876328LBIJA1&customer_order_id=TX121212</pre>
                    </section>
                    <!--//section-->
