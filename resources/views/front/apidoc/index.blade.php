...
<body>
    ...
    <div class="page-header theme-bg-dark py-5 text-center position-relative">
        ...
        <div class="container">
            ...
            <div class="page-intro single-col-max mx-auto">Everything you need to get your Payment API documentation
                here.</div>
        </div>
    </div>
    <!--//page-header-->
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    ...
                                    <!--//card-icon-holder-->
                                    <span class="card-title-text">Crypto Payment API</span>
                                </h5>
                                <div class="card-text">
                                    If you want to integrate the Crypto method in your System then you can prefer our
                                    this API.
                                </div>
                                <a class="card-link-mask" href="{{ route('cryptopayapi') }}"></a>
                            </div>
                            <!--//card-body-->
                        </div>
                        <!--//card-->
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title mb-3">
                                    ...
                                    <!--//card-icon-holder-->
                                    <span class="card-title-text">Hosted Payment API V2</span>
                                </h5>
                                <div class="card-text">
                                    In Hosted API v2 we provided more flexibility to user and we recommended to use our
                                    Hosted API v2 instead of v1.
                                </div>
                    ...
                    <div class="col-12 col-lg-4 py-3">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="card-text">
                                    To get any transaction details . you can use our Transaction Details API
                                </div>
