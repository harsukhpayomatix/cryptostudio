                    ...
                    <div class="basic-form">
                        <form action="{{ route('start-my-application-store') }}" method="post"
                            ...
                            <div class="form-row row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="accept_card"> Accepted Payment Methods <span
                                ...
                                <div class="form-group col-md-4">
                                    <label for="residential_address">Residential Address<span
                                            class="text-danger">*</span></label>
                                    <div class="input-div">
                                        <input type="text" id="residential_address" class="form-control"
                                            name="residential_address" placeholder="Enter here..."
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-div">
                                        <input type="text" id="business_address1" class="form-control"
                                            name="business_address1" placeholder="Enter here..."
                                ...
                                <div class="form-group col-md-4">
                                    <label for="country">Country Of Incorporation<span
                                            class="text-danger">*</span></label>
                                    <div class="input-div">
                                        {!! Form::select(
                                            'country',
                                ...
                                <div class="form-group col-md-4">
                                    @if ($isEdit)
                                        <input type="hidden" class="oldProccessingCountryVal"
                                            value="{{ $data->processing_country }}" />
                                    @else
                                        <input type="hidden" class="oldProccessingCountryVal"
                                            value="{{ old('processing_country[]') }}" />
                                    @endif
                                    <label for="processing_country">Processing Country<span
                                            class="text-danger">*</span></label>
                                    <div class="input-div">
                                        {!! Form::select(
                                            'processing_country[]',
                                    ...
                                    <div class="form-group mt-2 d-none otherProcessingInput">
                                        <label for="processing_country">Other Processing Country<span
                                                class="text-danger">*</span></label>
                                        <div class="input-div">
                                            <input type="text" class="form-control otherProcessingInputBox"
                                                placeholder="Enter here.." name="other_processing_country"
                                ...
                                <div class="form-group col-md-4">
                                    <label for="processing_currency">Processing Currency<span
                                            class="text-danger">*</span></label>
                                    <div class="input-div">
                                        {!! Form::select(
                                            'processing_currency[]',
                                ...
                                <div class="form-group col-md-4">
                                    <label for="technology_partner_id">Integration Preference<span
                                            class="text-danger">*</span></label>
                                    <div class="input-div">
                                        {!! Form::select(
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group mt-2 d-none toggleLicenceDocs">
                                        ...
                                        <div class="row">
                                            <div
                                                class="{{ $isEdit && $data->licence_document ? 'col-md-9' : 'col-md-12' }} ">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-div">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="number" name="monthly_volume" class="form-control"
                                                    placeholder="Enter here..."
                                ...
                                <div class="form-group col-md-4">
                                    <label for="company_license">Number of Directors<span
                                            class="text-danger">*</span></label>
                                    <div class="input-div">
                                        @if ($isEdit)
                                            <input type="hidden" class="boardOfDirectorVal"
                                                value="{{ $data->board_of_directors }}" />
                                            <input type="number" name="board_of_directors"
                                                class="form-control boardOfDirectors" placeholder="Enter here..."
                                                value="{{ $data->board_of_directors ? $data->board_of_directors : old('board_of_directors') }}"
                                                min="1" max="100" />
                                        @else
                                            <input type="number" name="board_of_directors"
                                                class="form-control boardOfDirectors" placeholder="Enter here..."
                                                value="{{ old('board_of_directors') ? old('board_of_directors') : 1 }}"
                                                min="1" max="100" />
                                        @endif
