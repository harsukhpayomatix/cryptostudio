...
@section('title')
    Trade Crypto To Fiat
@endsection

@section('breadcrumbTitle')
    <a href="{{ route('dashboardPage') }}">Dashboard</a> / <a href="{{ route('trade.index') }}">Trade</a> / Crypto To Fiat
@endsection

@section('content')
<div class="row">
    <div class="col-md-6">
        <h4 class="mt-50">Crypto To Fiat List</h4>
    </div>
    <div class="col-md-6 text-right">
        <a href="{{ route('trade.deposit.crypto') }}" class="btn btn-primary">Deposit </a>
                    ...
                    <table class="table table-borderless table-striped">
                        <thead>
                            <tr>
                                <th>Account ID</th>
                                <th>Currency Type</th>
                                <th>Amount <small style="font-size: 11px; text-transform: capitalize;">(<span class="text-success">Deposit</span>/<span class="text-danger">Withdrawal</span>)</small> </th>
                                <th>Status</th>
                        ...
                        <tbody>
                            @if (!empty($data) && $data->count())
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-success">{{ $value->amount }}</span>
                                        /
