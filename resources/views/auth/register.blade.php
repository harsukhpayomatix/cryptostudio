...
<head>
    ...
    <title>{{ config('app.name') }} | Merchant Register</title>
                ...
                <div class="col-md-4 col-xl-4 col-xxl-4 offset-md-4 offset-xl-4 offset-xxl-4 content-body">
                    <div class="row content-box-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 pr-0">
                                            <select class="form-control select2" name="country_code">
                                                <option value="44" {{ old('country_code')=='44' ?'selected':'' }}>UK
                                                    (+44)</option>
                        ...
                        <div class="col-md-12 mt-2">
                            <p class="text-center">Have already an account? <a href="{{route('login')}}" class="text-primary"> Sign In </a> </p>
                        </div>
                    </div>
                </div>
            </div>
