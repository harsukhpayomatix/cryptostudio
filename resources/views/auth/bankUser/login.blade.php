                ...
                <div class="col-md-8 col-xl-8 col-xxl-6 offset-md-2 offset-xl-2 offset-xxl-3 content-body">
                    <div class="row content-box-form">
                        ...
                        <div class="col-md-8 form-contant-right">
                            <h3>Sign In</h3>
                            <p>Enter your email address and password to access bank panel.</p>
                            <form action="{{ URL::route('bank/login') }}" id="login-form" method="post">
                                {!! csrf_field() !!}
                                ...
                                <div class="form-group mt-1">
                                    ...
                                    <input type="text" class="form-control" placeholder="E-mail" id="exampleInputEmail1" name="email" autofocus="" tabindex="1">
                                </div>
                                @if ($errors->has('email'))
                                ...
                                <div class="form-group mt-1">
                                    ...
                                    <div class="input-group rounded-input form-password-toggle">
                                        <input type="password" name="password" class="form-control" id="password" placeholder="Password" tabindex="2" id="exampleInputPassword1">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-1 text-right">
                                        <a href="{{ route('bank-password-reset') }}" class="text-primary">Forgot Password?</a>
                                    </div>
                                    <div class="col-md-12 mt-1">         
                                        <button class="btn btn-danger w-100 g-recaptcha" tabindex="4" data-sitekey="{{ config('app.captch_sitekey') }}" data-callback="onSubmit" data-action="submit">Sign In</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-md-12 mt-2">
                            <p class="text-center">Don't have an account? <a href="{{route('bank.register')}}" class="text-primary"> Sign Up </a> </p>
                        </div>
                    </div>
                </div>
            </div>
