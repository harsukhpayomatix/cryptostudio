                ...
                <div class="col-md-4 col-xl-4 col-xxl-4 offset-md-4 offset-xl-4 offset-xxl-4 content-body">
                    <div class="row content-box-form">
                        ...
                        <div class="col-md-12 form-contant-right">
                            <h3>OTP</h3>
                            <form action="{{ route('bank.cryptostudio-otp-store') }}" method="post" id="form" class="mt-4">
                                {!! csrf_field() !!}
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('bank.resend-otp') }}" class="btn btn-danger mt-1 w-100 disabled"
                                        disabled id="resendOTP">Resend OTP <span id="countdown">60s</span></a>
                                </div>
                            </form>
                        </div>

                        <div class="col-md-12 mt-2">
                            <p class="text-center">Back To <a href="{{route('bank/login')}}" class="text-primary"> Sign In </a> </p>
                        </div>
                    </div>
                </div>
            </div>
