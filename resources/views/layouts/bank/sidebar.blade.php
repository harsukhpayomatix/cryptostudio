        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if(bankApplicationStatus(auth()->guard('bankUser')->user()->id) == '1')
                <li class="{{ $pageActive == 'dashboard' ? 'active' : '' }}">
                    <a class="nav-link dropdown-item d-flex align-items-center" href="{{ route('bank.dashboard') }}">
                        <div class="svg-icon">
                ...
                <li class="dropdown nav-item {{ ($pageActive1 == 'bank.applications' || $pageActive1 == 'bank.applications.approved' || $pageActive1 == 'bank.applications.pending' || $pageActive1 == 'bank.applications.declined'|| $pageActive1 == 'bank.applications.referred') ? 'sidebar-group-active open' : ''  }}" data-menu="dropdown">
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        <li class="{{ $pageActive1 == 'bank.applications' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{!! route('bank.applications') !!}">
                        ...
                        <li class="{{ $pageActive1 == 'bank.applications.approved' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{route('bank.applications.approved')}}">
                        ...
                        <li class="{{ $pageActive1 == 'bank.applications.pending' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{route('bank.applications.pending')}}">
                        ...
                        <li class="{{ $pageActive1 == 'bank.applications.declined' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{route('bank.applications.declined')}}">
                        ...
                        <li class="{{ $pageActive1 == 'bank.applications.referred' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{route('bank.applications.referred')}}">
                ...
                <li class="dropdown nav-item {{ ($pageActive == 'merchant-transactions' || $pageActive == 'merchant-approved-transactions' || $pageActive == 'merchant-declined-transactions' || $pageActive == 'merchant-chargebacks-transactions' || $pageActive == 'merchant-refund-transactions') ? 'sidebar-group-active open' : ''  }}" data-menu="dropdown">
                    <a href="#" class="dropdown-toggle nav-link dropdown-item d-flex align-items-center" data-bs-toggle="dropdown">
                        <div class="svg-icon">
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        <li class="{{ $pageActive == 'merchant-transactions' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{ route('bank-merchant-transactions') }}">
                        ...
                        <li class="{{ $pageActive == 'merchant-approved-transactions' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{ route('bank-merchant-approved-transactions') }}">
                        ...
                        <li class="{{ $pageActive == 'merchant-declined-transactions' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{ route('bank-merchant-declined-transactions') }}">
                        ...
                        <li class="{{ $pageActive == 'merchant-chargebacks-transactions' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{ route('bank-merchant-chargebacks-transactions') }}">
                        ...
                        <li class="{{ $pageActive == 'merchant-refund-transactions' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{ route('bank-merchant-refund-transactions') }}">
                ...
                <li class="dropdown nav-item {{ ($pageActive == 'risk-report') || ($pageActive == 'merchant-volume') ? 'sidebar-group-active open' : ''  }}" data-menu="dropdown">
                    <a href="#" class="dropdown-toggle nav-link dropdown-item d-flex align-items-center" data-bs-toggle="dropdown">
                        <div class="svg-icon">
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        <li class="{{ $pageActive == 'merchant-volume' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{ route('bank-merchant-volume-report') }}">
                                <span class="menu-title text-truncate" data-i18n="Merchant Volume">Merchant Volume</span>
                            </a>
                        </li>                        
                        
                        <li class="{{ $pageActive == 'risk-report' ? 'active' : '' }}">
                            <a class="dropdown-item dropdown-item d-flex align-items-center" href="{{ route('bank.risk-report') }}">
