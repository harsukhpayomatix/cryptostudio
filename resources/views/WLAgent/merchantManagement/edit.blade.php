...
@section('breadcrumbTitle')
    <a href="{{ route('wl-dashboard') }}">Dashboard</a> / <a href="{{ route('wl-merchant-management') }}">Merchant
        Management</a> / Edit
@endsection
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::model($data, ['route' => ['wl-merchant-update', $data->id], 'method' => 'PUT', 'class' => 'form form-dark form-horizontal', 'enctype' => 'multipart/form-data']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div class="main-select-phone d-flex justify-content-between align-items-center">
                                        <select class="select2 form-control" name="country_code" data-size="7"
                                            data-live-search="true" data-title="-- Select Country Code --" id="country"
                                            data-width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ getS3Url($extra_document) }}" target="_blank"
                                                                class="btn btn-danger btn-sm">Show</a>
                                                ...
                                                @foreach (Input::old('wl_extra_document') as $key => $value)
                                                    <tr data-id={{ $key == 0 ? $key + 1 : $key }}>
                                                        ...
                                                        <td>
                                                            <div class="custom-file">
                                                                ...
                                                                {{-- <label class="custom-file-label"
                                                                    for="validationCustomFile-{{ $key }}">Choose
                                                                    file...</label> --}}
                                                            </div>
                                                        ...
                                                        <td class="text-center">
                                                            @if ($key == 0)
                                                                <button type="button"
                                                                    class="btn btn-primary btn-sm plus"> <i
                                                                        class="fa fa-plus"></i>
                                                                </button>
                                                            @else
                                                                <button type="button"
    ...
    <script type="text/javascript">
        ...
        $("body").on('click', '.plus-ip', function() {
            ...
            $("#tab_logic_ip").append(
				...
				<td class="text-center">
					<button type="button" class="btn btn-primary plus-ip btn-sm"> <i class="fa fa-plus"></i>
					</button>
					<button type="button" class="btn btn-danger minus btn-sm"> <i class="fa fa-minus"></i> </button>\
				</td>
			</tr>`
            )
        })
