                        ...
                        <table class="table table-borderless table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="3" class="text-center text-info">RETRIEVAL</th>
                                ...
                                @if (count($transactions_summary) > 0)
                                    @foreach ($transactions_summary as $transaction)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                {{ number_format($transaction['retrieval_amount'], 2, '.', ',') }}</td>
                                            <td class="text-right">{{ round($transaction['retrieval_percentage'], 2) }}
                                            </td>
