...
@section('breadcrumbTitle')
    <a href="{{ route('wl-dashboard') }}">Dashboard</a> / Crypto Transactions
@endsection
                ...
                <div class="card-header">
                    ...
                    <div>
                        <div class="btn-group mr-2">
                            ...
                            <a href="{{ route('wl-merchant-transaction-crypto') }}" class="btn btn-sm btn-danger"
                                style="border-radius: 0px 5px 5px 0px !important;">Reset</a>
                        </div>
                        <a href="{{ route('wl-merchant-crypto-transaction-excel', request()->all()) }}"
