            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="{!! url('rp/merchant-retrieval-transactions') !!}">
                                <div class="d-flex align-items-center mb-sm-0 mb-3">
                                    <div class="d-inline-block relative donut-chart-sale mr-3">
                                        <span class="donut"
                                            data-peity='{ "fill": ["#C9302C", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'>1.5/10</span>
                                        <small>
                                            <i class="flaticon-381-transfer"
                                                style="font-size: 34px; color:#C9302C;"></i>
                                        </small>
                                    </div>
                                    <div>
                                        <h4 class="fs-18 text-black">Retrieval ({{ $retrievalPercentage }}%)</h4>
                                        <span>{{ $transaction->retrieval }}</span>
                                    </div>
                                </div>
                            </a>
                        </div>
