    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open([
                        'route' => 'user-management-agent-store',
                        'method' => 'POST',
                        'class' => 'form
                                                                                                                                                                                                                                        form-horizontal',
                    ]) !!}
                    <div class="row form-dark">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <input type="text" name="mobile_no" value="{{ old('mobile_no') }}"
                                        class="form-control w-100" id="mobile_no" placeholder="Enter here...">
                                </div>
                            </div>
                        ...
                        @if (auth()->guard('agentUser')->user()->is_wl_merchant_allow == '1')
                            <div class="form-group col-lg-4">
                                <label for="">Whitelable Merchant</label>
                                <div class="basic-form">
                                    <div class="form-group mb-0">
                                        <label class="radio-inline mr-3">
                                            <input type="radio" name="is_whitelable" class="checkradio md-radiobtn"
