...
@section('breadcrumbTitle')
    <a href="{{ route('rp.dashboard') }}">Dashboard</a> / Retrieval Transactions
@endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Retrieval Transactions</h4>

                    <div>
                        <div class="btn-group mr-2">
                            <button type="button" class="btn btn-primary btn-sm bell-link" data-bs-toggle="modal"
                            ...
                            <a href="{{ route('rp-merchant-retrieval-transactions') }}"
                                class="btn btn-sm btn-danger">Reset</a>
                        </div>
                        @if (!empty($subQueryString))
                            <a href="{{ route('rp-merchant-retrieval-transactions', ['type' => 'xlsx'] + request()->all(), [$subQueryString]) }}"
                                class="btn-primary btn-sm mx-1" id="ExcelLink"><i class="fa fa-download"></i>
                                Export Excel</a>
                        @else
                            <a href="{{ route('rp-merchant-retrieval-transactions', ['type' => 'xlsx'] + request()->all()) }}"
                                class="btn btn-primary btn-sm mx-1" id="ExcelLink"><i class="fa fa-download"></i>
                                Export Excel</a>
                        @endif

                        <form class="pull-right form-dark" method="GET" id="search-form2">
                                    ...
                                    <tr id="tr_{{ $transaction->id }}">
                                        <td>
                                            <a href="javascript:;" data-bs-target="#transactionShowModal"
                                                data-bs-toggle="modal" class=" showTransaction"
                                                data-id="{{ $transaction->id }}"
                                                data-link="{{ route('rp.merchant-transactions-details') }}">
                                                <strong
                                                    class="text-danger transOrderNo">{{ $transaction->order_id }}</strong>
                                            </a>
                                        </td>
