...
@section('breadcrumbTitle')
    <a href="{{ route('rp.dashboard') }}">Dashboard</a> / Marked Transactions
@endsection
                    ...
                    <div class="modal-body">
                        <div class="basic-form">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="text">Marked Start Date</label>
                                    <div class="date-input">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="text">Marked End Date</label>
                                    <div class="date-input">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="iq-header-title">
                        <h4 class="card-title">Marked Transactions</h4>
                    </div>
                    <div>
                        <div class="btn-group mr-2">
                            ...
                            <a href="{{ route('rp-merchant-suspicious-transactions') }}"
                                class="btn btn-danger btn-sm">Reset</a>
                        </div>
                        @if (!empty($subQueryString))
                            <a href="{{ route('rp-merchant-suspicious-transactions', ['type' => 'xlsx'] + request()->all(), [$subQueryString]) }}"
                                class="btn btn-primary btn-sm mx-1" id="ExcelLink"><i class="fa fa-download"></i>
                                Export Excel</a>
                        @else
                            <a href="{{ route('rp-merchant-suspicious-transactions', ['type' => 'xlsx'] + request()->all()) }}"
                                class="btn btn-primary btn-sm mx-1" id="ExcelLink"><i class="fa fa-download"></i>
                                Export Excel</a>
                        @endif
