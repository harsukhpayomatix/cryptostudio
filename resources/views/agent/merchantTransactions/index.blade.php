...
@section('breadcrumbTitle')
    <a href="{{ route('rp.dashboard') }}">Dashboard</a> / All Transactions
@endsection
                ...
                <div class="card-header">
                    ...
                    <div>
                        <div class="btn-group mr-2">
                            ...
                            <a href="{{ route('rp-merchant-transactions') }}" class="btn btn-danger btn-sm">Reset</a>
                        </div>
                        <a href="{{ route('rp-merchant-transactions', ['type' => 'xlsx'] + request()->all()) }}"
                            class="btn btn-primary btn-sm mx-1" id="ExcelLink"><i class="fa fa-download mr-2"></i>
                            Export Excel</a>
