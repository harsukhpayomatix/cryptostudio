...
@section('breadcrumbTitle')
    <a href="{{ route('rp.dashboard') }}">Dashboard</a> / Chargebacks Transactions
@endsection
                    ...
                    <div class="modal-body">
                        <div class="basic-form">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="text">Chargeback Start Date</label>
                                    <div class="date-input">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="text">Chargeback End Date</label>
                                    <div class="date-input">
                                        <input class="form-control" type="text" name="chargebacks_end_date"
                                            placeholder="Enter here..." id="chargebacks_end_date"
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Chargebacks Transactions</h4>
                    ...
                    <div>
                        <div class="btn-group mr-2">
                            ...
                            <a href="{{ route('rp-merchant-chargebacks-transactions') }}"
                                class="btn btn-sm btn-danger">Reset</a>
                        </div>
                        @if (!empty($subQueryString))
                            <a href="{{ route('rp-merchant-chargebacks-transactions', ['type' => 'xlsx'] + request()->all(), [$subQueryString]) }}"
                                class="btn btn-primary btn- mx-1" id="ExcelLink"><i class="fa fa-download"></i>
                                Export Excel</a>
                        @else
                            <a href="{{ route('rp-merchant-chargebacks-transactions', ['type' => 'xlsx'] + request()->all()) }}"
