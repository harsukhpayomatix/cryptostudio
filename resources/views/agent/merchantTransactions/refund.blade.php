...
@section('breadcrumbTitle')
    <a href="{{ route('rp.dashboard') }}">Dashboard</a> / Refund Transactions
@endsection
@section('customStyle')
@endsection
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Refund Transactions</h4>
                    ...
                    <div>
                        ...
                        @if (!empty($subQueryString))
                            <a href="{{ route('rp-merchant-refund-transactions', ['type' => 'xlsx'] + request()->all(), [$subQueryString]) }}"
                                class="btn-sm btn btn-primary btn-sm mx-1" id="ExcelLink"><i class="fa fa-download"></i>
                                Export Excel</a>
                        @else
                            <a href="{{ route('rp-merchant-refund-transactions', ['type' => 'xlsx'] + request()->all()) }}"
