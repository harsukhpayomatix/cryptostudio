...
@section('breadcrumbTitle')
    <a href="{{ route('rp.dashboard') }}">Dashboard</a> / Payment Status Summary Report
@endsection
@section('content')
    <div class="chatbox">
                        ...
                        <div class="basic-form">
                            <div class="row">
                                ...
                                <div class="col-sm-12 mt-2">
                                    <button type="submit" class="btn btn-danger" id="extraSearch123">Cancel</button>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn-group mr-2">
                        <button type="button" class="btn btn-primary bell-link btn-sm">
                            Advanced Search &nbsp;
                        ...
                        <a href="{{ route('rp.rp-payment-status-report') }}" class="btn btn-danger btn-sm">Reset</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <table class="table table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($arr_t_data as $user_transaction)
                                        ...
                                        @foreach ($user_transaction as $k => $transaction)
                                            <tr>
                                                @if ($k == 0)
