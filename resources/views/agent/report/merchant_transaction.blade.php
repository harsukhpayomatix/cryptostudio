                    ...
                    <div class="modal-body">
                        <div class="basic-form">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <label for="end_date">Retrieval Percentage(Greater Than)</label>
                                    <div class="date-input">
                                        <input type="number" min="0" id="retrieval_per" class="form-control"
                                            name="retrieval_per"
                                            value="{{ isset($_GET['retrieval_per']) && $_GET['retrieval_per'] != '' ? $_GET['retrieval_per'] : '' }}"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group col-lg-6">
    ...
    <div class="row">
        <div class="col-md-12 transaction-summary-tbl">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 p-0" style="min-height: 400px;">
                            <div class="row">
                            ...
                            <ul class="nav nav-tabs d-flex flex-column align-items-start mt-2" data-tabs="tabs">
                                <li class="nav-item">
                        ...
                        <div class="col-md-9 pt-2"
                            style="border-radius: 4px; position: relative; box-shadow: rgb(0 0 0 / 40%) -5px 5px 10px 0px, rgb(0 0 0 / 30%) -3px 3px 3px -5px;">
                            <h5 class="text-center text-white">Transaction Summary Report</h5>
                            <div class="tab-content text-center" style="padding: 0px 30px;">
                                <div class="tab-pane active table-responsive custom-table" id="SUCCESSFUL">
                                                ...
                                                @foreach ($transactions_summary as $userid => $c_transaction)
                                                    ...
                                                    @foreach ($c_transaction as $transaction)
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{{ $transaction['success_amount'] }}
                                                            </td>
                                                            <td class="text-right">
                                ...
                                <div class="tab-pane table-responsive custom-table" id="DECLINED">
                                    <table class="table table-borderless table-striped">
                                        <thead>
                                            <tr>
                                                <th>Merchant</th>
                                ...
                                <div class="tab-pane table-responsive custom-table" id="CHARGEBACKS">
                                    <table class="table table-borderless table-striped">
                                        <thead>
                                            <tr>
                                                <th>Merchant</th>
                                ...
                                <div class="tab-pane table-responsive custom-table" id="REFUND">
                                    <table class="table table-borderless table-striped">
                                        <thead>
                                            <tr>
                                                <th>Merchant</th>
                                ...
                                <div class="tab-pane table-responsive custom-table" id="SUSPICIOUS">
                                    <table class="table table-borderless table-striped">
                                        <thead>
                                            <tr>
                                                <th>Merchant</th>
                                ...
                                <div class="tab-pane table-responsive custom-table" id="RETRIEVAL">
                                    <table class="table table-borderless table-striped">
                                        <thead>
                                            <tr>
                                                <th>Merchant</th>
                                ...
                                <div class="tab-pane table-responsive custom-table" id="BLOCK">
                                    <table class="table table-borderless table-striped">
                                        <thead>
                                            <tr>
                                                <th>Merchant</th>
