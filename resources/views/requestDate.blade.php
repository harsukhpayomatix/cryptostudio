@php
    ...
    if (isset($_GET['retrieval_start_date']) && $_GET['retrieval_start_date'] != '') {
        $start = explode(' ', $_GET['retrieval_start_date']);
        $_GET['retrieval_start_date'] = date('d-m-Y', strtotime($start[0]));
    }
    if (isset($_GET['retrieval_end_date']) && $_GET['retrieval_end_date'] != '') {
        $end = explode(' ', $_GET['retrieval_end_date']);
        $_GET['retrieval_end_date'] = date('d-m-Y', strtotime($end[0]));
    }
