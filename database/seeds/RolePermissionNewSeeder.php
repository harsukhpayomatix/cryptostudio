    ...
    public function run()
    {
        $actions = [
            ...
            [
	            ...
	            'name' => 'list-payment-status-summary-report',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'report',
	            'sub_module' => 'payment status summary report',
	            ...
	            'name' => 'list-auto-suspicious-report',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'report',
	            'sub_module' => 'auto suspicious report',
            ...
            [
	            'module' => 'admin report',
	            'sub_module' => 'aggregated declined transactions reasons',
	            'name' => 'aggregated-declined-transactions-reasons',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'admin report',
	            'sub_module' => 'merchant transaction responses',
	            'name' => 'view-merchant-transaction-responses',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'admin report',
	            'sub_module' => 'merchant transaction responses',
	            ...
	            'module' => 'admin report',
	            'sub_module' => 'mid approval rate',
	            'name' => 'view-mid-approval-rate',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'admin report',
	            'sub_module' => 'mid country report',
	            'name' => 'view-mid-country-wise-report',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'admin report',
	            'sub_module' => 'merchant country report',
	            'name' => 'view-merchant-country-wise-report',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'admin report',
	            'sub_module' => 'merchant daily report',
	            'name' => 'view-merchant-daily-report',
	            'guard_name' => 'admin'
            ],
            ...
            [
	            ...
	            'name' => 'list-generated-payout-reports',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'payout report',
	            'sub_module' => 'generate merchant payout report',
            ...
            [
	            'module' => 'payout report',
	            'sub_module' => 'agent payout report',
	            'name' => 'list-rp-payout-reports',
	            'guard_name' => 'admin'
            ],
            ...
            [
	            ...
	            'module' => 'technical additional',
	            'sub_module' => 'merchant rp agreement',
	            'name' => 'view-merchant-rp-agreement',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'technical additional',
	            ...
	            'module' => 'technical additional',
	            'sub_module' => 'payout schedule',
	            'name' => 'view-payout-schedule',
	            'guard_name' => 'admin'
            ],[
	            'module' => 'technical additional',
